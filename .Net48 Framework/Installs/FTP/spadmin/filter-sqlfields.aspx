<%@ page language="C#" viewstatemode="Enabled" codebehind="filter-sqlfields.aspx.cs" inherits="wwwroot.filter_sqlfields" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function assignFieldValue(objField, sFieldName) {
            parent.document.getElementById("Head" + objField).value = sFieldName;
            parent.document.getElementById("Body" + objField).value = "[[" + sFieldName + "]]";
        ...
        <div class="GridViewStyle">
            <asp:gridview id="ManageGridView" runat="server" autogeneratecolumns="False" allowsorting="True" clientidmode="Static"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <a href="javascript:assignFieldValue('<%= SepCommon.SepCore.Request.Item("PopulateField") %>', '<%#
                this.Eval("FieldName") %>')"><%#
