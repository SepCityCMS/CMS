...
// ***********************************************************************
// <copyright file="email_templates_modify.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class email_templates_modify.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class email_templates_modify : Page
    {
        /// <summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    ModifyLegend.InnerHtml = SepFunctions.LangText("Add Email Template");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                var jEmail = SepCommon.DAL.EmailTemplates.Template_Get(SepFunctions.toLong(SepCommon.SepCore.Request.Item("TemplateID")));

                if (jEmail.TemplateID == 0)
                {
                ...
                {
                    ModifyLegend.InnerText = SepFunctions.LangText("Edit Email Template");
                    TemplateID.Value = SepCommon.SepCore.Request.Item("TemplateID");
                    TemplateName.Value = jEmail.TemplateName;
                    EmailSubject.Value = jEmail.EmailSubject;
                    EmailBody.Text = jEmail.EmailBody;
                }
            }
            else
            {
                if (string.IsNullOrWhiteSpace(TemplateID.Value)) TemplateID.Value = Strings.ToString(SepFunctions.GetIdentity());
            }
        }
        ...
        {
            var sReturn = SepCommon.DAL.EmailTemplates.Template_Save(SepFunctions.toLong(TemplateID.Value), TemplateName.Value, EmailSubject.Value, EmailBody.Text);
