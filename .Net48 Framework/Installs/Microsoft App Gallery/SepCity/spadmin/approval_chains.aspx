<%@ page title="Approval Chains" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="approval_chains.aspx.cs" inherits="wwwroot.approval_chains" %>
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <div class="panel panel-default" id="PageManageGridView" runat="server">
						...
						<div class="input-group">
							<select id="FilterDoAction" runat="server" class="form-control" ClientIDMode="Static">
								<option value="">Select an Action</option>
									<option value="DeleteChains">Delete Approval Chains</option>
                    </select>
							<span class="input-group-btn">
							<button class="btn btn-light" ID="RunAction" runat="server" OnServerClick="RunAction_Click" onclick="if(ExecuteAction(this, 'ChainID') == false) {return false} else">Go!</button>
						</span>
					</div>
				</div>
				<div class="col-lg-6">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                Eval("ApproveID").ToString()%>" value="<%#
                Eval("ApproveID").ToString()%>" onclick="gridviewSelectRow(this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:templatefield ItemStyle-Width="20px">
                        <itemtemplate>
                            <a href="approval_chains_modify.aspx?ChainID=<%#
                Eval("ApproveID").ToString()%>">
