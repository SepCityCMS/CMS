...
namespace SepCommon.Core.DAL
{
    ...
    public static class RecycleBin
    {
        ...
        public static string Recycle_Bin_Delete(string UniqueIDs)
        {
            ...
            using (var conn = new SqlConnection(SepFunctions.Database_Connection()))
            {
                ...
                if (arrUniqueIDs != null)
                {
                    ...
                    {
                        ModuleID = SepFunctions.toInt(Strings.Split(arrUniqueIDs[i], "||")[0]);
                        switch (ModuleID)
                        {
                            case 1:
            ...
            sReturn = SepFunctions.LangText("Recycled Item(s) has been successfully deleted.");
        ...
        public static string Recycle_Bin_Restore(string UniqueIDs)
        {
            ...
            sReturn = SepFunctions.LangText("Recycled Item(s) has been successfully restored.");
