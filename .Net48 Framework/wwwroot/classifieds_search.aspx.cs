...
// ***********************************************************************
// <copyright file="classifieds_search.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class classifieds_search.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class classifieds_search : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                if (Page.IsPostBack) ErrorMessage.InnerHtml = "<div class=\"alert alert-danger\" role=\"alert\">" + SepFunctions.LangText("You must enter a keyword to run the search.") + "</div>";
                ...
                if (Results.Rows.Count == 0) ErrorMessage.InnerHtml = "<div class=\"alert alert-danger\" role=\"alert\">" + SepFunctions.LangText("There are no search results to return.") + "</div>";
                else ErrorMessage.InnerHtml = string.Empty;
            }
            else
            {
