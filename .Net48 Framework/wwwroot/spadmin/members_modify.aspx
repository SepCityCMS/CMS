<%@ page title="Members" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="members_modify.aspx.cs" inherits="wwwroot.members_modify" %>
...
<asp:content id="HeaderContent" runat="server" contentplaceholderid="HeadContent">
    ...
    <script type="text/javascript">
        ...
        function openGeneralInfo() {
            ...
            $('#tabSecurity a').removeClass('btn-info');
        ...
        function openUserSecurity() {
            $('#FieldFilterDiv').remove();
            $('#tabGeneral a').removeClass('btn-info');
            $('#tabContact a').removeClass('btn-info');
            $('#tabSecurity a').addClass('btn-info');
            $('#tabOther a').removeClass('btn-info');
            $("#GeneralInfo").hide();
            $("#ContactInfo").hide();
            $("#MoreInfo").hide();
            $("#UserSecurity").show();
            restyleFormElements('#UserSecurity');
        }
        ...
        <div class="ModFormDiv" id="ModFormDiv" runat="server">
                ...
                <input type="hidden" runat="server" ID="ReferralID" ClientIDMode="Static" />
                    ...
                    <div class="panel panel-default" id="PageManageGridView" runat="server">
                        <div class="panel-body">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item" role="presentation" id="tabSecurity">
                                    <a class="nav-link" href="javascript:void(0)" onclick="openUserSecurity();">User Security</a>
                                </li>
                    ...
                    <div class="panel-body">
                        ...
                        <div id="UserSecurity" style="display: none">
                            <div class="mb-3">
                                <label ID="PointsLabel" clientidmode="Static" runat="server" for="Points">Credits:</label>
                                <input type="text" ID="Points" runat="server"  class="form-control" MaxLength="10" ClientIDMode="Static" Text="0" />
                            </div>
                            <div class="mb-3">
                                <label ID="AccessClassLabel" clientidmode="Static" runat="server" for="AccessClass">Access Class:</label>
                                <sep:AccessClassDropdown ID="AccessClass" runat="server" CssClass="form-control" ClientIDMode="Static" />
                            </div>
                            <div class="mb-3">
                                <label ID="AccessKeysLabel" clientidmode="Static" runat="server" for="AccessKeys">Access Keys:</label>
                                <sep:AccessKeySelection ID="AccessKeys" runat="server" ClientIDMode="Static" />
                            </div>
                        </div>
                        <div id="MoreInfo" style="display: none">
                            ...
                            <div class="mb-3" id="PortalsRow" runat="server">
                                ...
                                <sep:PortalDropdown ID="Portal" runat="server" CssClass="form-control" ClientIDMode="Static" />
                            </div>
                            ...
                            <div class="mb-3">
                                <asp:CheckBox ID="HideTips" runat="server" Text="Hide Tips" />
                            </div>
                            <div class="mb-3">
