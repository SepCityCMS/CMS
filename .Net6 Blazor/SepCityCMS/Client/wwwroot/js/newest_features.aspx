<%@ page language="C#" CodeBehind="newest_features.aspx.cs" Inherits="wwwroot.newest_features" %>
...
<form id="form1" runat="server">
    <p align="center">
        <select name="dinsNum" id="dinsNum">
        ...
        </select> <select ID="dinsFeature" runat="server" ClientIDMode="Static">
