<%@ page title="Web Pages" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="webpages.aspx.cs" inherits="wwwroot.webpages" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <% 
            ...
            if(ModuleID > 0) {
                cAdminModuleMenu.ModuleID = ModuleID;
            }
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Manage the Web Pages"></span>
        </h2>
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                Eval("UniqueID").ToString()%>" onclick="gridviewSelectRow(this);" /> 
                    ...
                    <asp:templatefield ItemStyle-Width="20px">
                        <itemtemplate>
                            <a href="<%#
                "webpages_" + Convert.ToString(Eval("PageID").ToString() == "201" ? "link_" : "") +
                ...
                "&PortalID=" + SepCommon.SepCore.Request.Item("PortalID")%>">
                ...
                "||" + Eval("RowNumber").ToString() + "||" + Eval("MenuID").ToString()%>' />
                    ...
                    <asp:templatefield HeaderText="URL" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Top" ItemStyle-Width="30px">
                        <itemtemplate>
                            <%# Convert.ToString(Eval("PageID").ToString() == "200" ? "<center><a href=\"javascript:void(0)\" onclick=\"popupURL('" + GetInstallFolder() + "page/" + Eval("UniqueID").ToString() + "/" + Format_ISAPI(Eval("LinkText").ToString()) + "');return false;\">URL</a></center>" : "")%>
                        </itemtemplate>
                    </asp:templatefield>
                </Columns>
