...
namespace SepCommon.DAL
{
    ...
    public static class Friends
    {
        ...
        public static string Friends_Approve(string FriendID, string UserID)
        {
            ...
            string sReturn = SepFunctions.LangText("Friend has been already approved.");
        ...
        public static string Friends_Delete(string FriendIDs)
        {
            ...
            return SepFunctions.LangText("Friend(s) has been successfully deleted.");
        }
        ...
        public static string Friends_Save(string FriendUserName, string Username)
        {
            ...
            string sReturn = SepFunctions.LangText("User has been successfully added to your friends list.");
