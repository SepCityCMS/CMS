...
// ***********************************************************************
// <copyright file="forms_submissions.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class forms_submissions.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class forms_submissions : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Submissions");
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Form Name");
                    ManageGridView.Columns[3].HeaderText = SepFunctions.LangText("Email Address");
                    ManageGridView.Columns[4].HeaderText = SepFunctions.LangText("User Name");
                    ManageGridView.Columns[5].HeaderText = SepFunctions.LangText("Date Submitted");
                }
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No submissions have been added.") + "</div>";
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.Forms.Submissions_Delete(sIDs);
        ...
        {
            var dForms = SepCommon.DAL.Forms.GetFormsSubmissions();
