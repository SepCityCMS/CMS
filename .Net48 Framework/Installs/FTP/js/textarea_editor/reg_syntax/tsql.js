editAreaLoader.load_syntax["tsql"] = {
    ...
    'KEYWORDS': {
        ...
        'functions': [
            ...
            "AVG", "MIN", "CHECKSUM", "SUM", "CHECKSUM_AGG", "STDEV", "COUNT", "STDEVP", "COUNT_BIG", "VAR", "GROUPING",
            "VARP", "MAX",
            "@@DATEFIRST", "@@OPTIONS", "@@DBTS", "@@REMSERVER", "@@LANGID", "@@SERVERNAME", "@@LANGUAGE",
            "@@SERVICENAME", "@@LOCK_TIMEOUT",
            ...
            "ABS", "DEGREES", "RAND", "ACOS", "EXP", "ROUND", "ASIN", "FLOOR", "SIGN", "ATAN", "LOG", "SIN", "ATN2",
            "LOG10", "SQRT",
            "CEILING", "PI ", "SQUARE", "COS", "POWER", "TAN", "COT", "RADIANS",
            "@@PROCID", "COL_LENGTH", "FULLTEXTCATALOGPROPERTY", "COL_NAME", "FULLTEXTSERVICEPROPERTY",
            "COLUMNPROPERTY", "INDEX_COL",
            "DATABASEPROPERTY", "INDEXKEY_PROPERTY", "DATABASEPROPERTYEX", "INDEXPROPERTY", "DB_ID", "OBJECT_ID",
            "DB_NAME", "OBJECT_NAME",
            "FILE_ID", "OBJECTPROPERTY", "OBJECTPROPERTYEX", "FILE_NAME", "SQL_VARIANT_PROPERTY", "FILEGROUP_ID",
            "FILEGROUP_NAME",
            "FILEGROUPPROPERTY", "TYPEPROPERTY", "FILEPROPERTY",
            "CURRENT_USER", "SUSER_ID", "SUSER_SID", "IS_MEMBER", "SUSER_SNAME", "IS_SRVROLEMEMBER", "PERMISSIONS",
            "SYSTEM_USER",
            "SUSER_NAME", "USER_ID", "SESSION_USER", "USER_NAME", "ASCII", "SOUNDEX", "PATINDEX", "SPACE", "CHARINDEX",
            "QUOTENAME",
            "STR", "DIFFERENCE", "REPLACE", "STUFF", "REPLICATE", "SUBSTRING", "LEN", "REVERSE", "UNICODE", "LOWER",
            "UPPER", "LTRIM", "RTRIM", "APP_NAME", "CAST", "CONVERT", "COALESCE", "COLLATIONPROPERTY",
            "COLUMNS_UPDATED", "CURRENT_TIMESTAMP",
            "CURRENT_USER", "DATALENGTH", "@@ERROR", "FORMATMESSAGE", "GETANSINULL", "HOST_ID", "HOST_NAME",
            "IDENT_CURRENT", "IDENT_INCR",
            "IDENT_SEED", "@@IDENTITY", "ISDATE", "ISNULL", "ISNUMERIC", "NEWID", "NULLIF", "PARSENAME", "@@ROWCOUNT",
            "SCOPE_IDENTITY", "SERVERPROPERTY", "SESSIONPROPERTY", "SESSION_USER", "STATS_DATE", "SYSTEM_USER",
            "@@TRANCOUNT", "USER_NAME",
