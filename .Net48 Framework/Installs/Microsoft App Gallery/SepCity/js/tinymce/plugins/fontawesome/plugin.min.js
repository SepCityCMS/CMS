...
tinymce.PluginManager.add('fontawesome', function (editor, url) {
    var fontawesome_size = '';
    var fontawesome_mode = '';
    ...
    function showDialog() {
            ...
            for (var y = 0; y < (iconGroup.length / width); y++) {
                for (var x = 0; x < width; x++) {
                    if (iconGroup[y * width + x]) {
                        ...
                        gridHtml += '<div class="mce-icon-cell js-mce-fontawesome-insert" title="' + name + '" data-id="' + id + '"' + (group === 'spinnerIcons' ? ' data-spin="true"' : '') + '>';
            ...
            items: [
                {
                    ...
                    label: 'Size',
                    'values': [
                        { text: 'Normal Size', value: '' },
                        { text: 'Large', value: 'fa-lg' },
                        { text: '2x Large', value: 'fa-2x' },
                        { text: '3x Large', value: 'fa-3x' },
                        { text: '4x Large', value: 'fa-4x' },
                        { text: '5x Large', value: 'fa-5x' }
                    ],
                    onselect: function (v) {
                        fontawesome_size = this.value();
                    }
                },
                {
                    type: 'listbox',
                    ...
                    'values': [
                        { text: 'Normal', value: ' ' },
                        { text: 'Bordered', value: 'fa-border' },
                        { text: 'Fixed Width', value: 'fa-fw' },
                    ],
                    onselect: function (v) {
                        fontawesome_mode = this.value();
                    }
                },
                {
                    label: 'Color',
        ...
        function insertIcon() {
            ...
            var content = '<i class="fa fa-' + id + ' ' + fontawesome_size + ' ' + fontawesome_mode + '" style="color: ' + iconColor + '"></i>';
            fontawesome_size = '';
            fontawesome_mode = '';
    ...
    editor.ui.registry.addMenuButton('fontawesome', {
    ...
    /* START MAKE ELEMENT NON EDITABLE */
    var setContentEditable = function (state) {
        return function (nodes) {
            for (var i = 0; i < nodes.length; i++) {
                var node = nodes[i];
                if (typeof node.attr('class') !== 'undefined' && node.attr('class').includes('fa') && node.attr('class').includes('fa-')) { /* !node.firstChild */ // important
    ...
    editor.on('PreInit', function () {
        editor.parser.addNodeFilter('i', setContentEditable('false'));
        editor.serializer.addNodeFilter('i', setContentEditable(null));
    });
    /* END MAKE ELEMENT NOT EDITABLE */
