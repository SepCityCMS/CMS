...
// ***********************************************************************
// <copyright file="shoppingmall.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class shoppingmall : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        {
            var dShopProducts = SepCommon.DAL.ShoppingMall.GetShopProducts(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value, showSalesOnly: false, hideImportedItems: true);
