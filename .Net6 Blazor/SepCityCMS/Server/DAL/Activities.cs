...
namespace SepCityCMS.Server.DAL
{
    ...
    public static class Activities
    {
        ...
        public static string ActivityDelete(string ActivityIDs)
        {
            ...
            sReturn = SepFunctions.LangText("Activity(s) has been successfully deleted.");
        ...
        /// <returns>System.String.</returns>
        public static string ActivitySave(ref long ActivityID, string ActUserID, string ActivityType, string Description)
        {
            var bUpdate = false;
            ...
            sReturn = SepFunctions.LangText("Activity has been successfully added.");
