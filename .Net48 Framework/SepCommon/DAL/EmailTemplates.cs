...
namespace SepCommon.DAL
{
    ...
    public static class EmailTemplates
    {
        ...
        public static string Template_Delete(string TemplateIDs)
        {
            ...
            return SepFunctions.LangText("Email Template(s) has been successfully deleted.");
        }
        ...
        public static string Template_Save(long TemplateID, string TemplateName, string EmailSubject, string EmailBody)
        {
            ...
            string sReturn = SepFunctions.LangText("Email template has been successfully added.");
