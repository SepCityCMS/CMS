...
// ***********************************************************************
// <copyright file="shopping_my_products.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class shopping_my_products.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class shopping_my_products : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        /// </summary>
        /// <param name="sPrice">The s price.</param>
        /// <returns>System.String.</returns>
        public string Format_Currency(string sPrice)
        {
            return SepFunctions.Format_Currency(sPrice);
        }
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Products");
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Product Name");
                    ManageGridView.Columns[3].HeaderText = SepFunctions.LangText("Item Price");
                    ManageGridView.Columns[4].HeaderText = SepFunctions.LangText("Handling Fee");
                }
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No products/services have been added.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.ShoppingMall.Product_Delete(sIDs);
        ...
        {
            var dShopProducts = SepCommon.DAL.ShoppingMall.GetShopProducts(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value, showSalesOnly: false, hideImportedItems: true, UserID: SepFunctions.Session_User_ID());
