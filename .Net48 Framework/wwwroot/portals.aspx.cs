...
namespace wwwroot
{
    ...
    public partial class portals1 : Page
    {
        /// <summary>
        /// Binds the data.
        /// </summary>
        public void BindData()
        {
            ...
            {
                cPortals = SepCommon.DAL.Portals.GetPortals(CatID: SepFunctions.toLong(SepCommon.SepCore.Request.Item("CatID")), showHidden: false);

                ListContent.DataSource = cPortals.ToArray();
                ListContent.DataBind();
            }
            else
            {
                cPortals = SepCommon.DAL.Portals.GetPortals(showHidden: false);
