...
// ***********************************************************************
// <copyright file="customfields_sections_modify.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class customfields_sections_modify.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class customfields_sections_modify : Page
    {
        /// <summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    SectionTextLabel.InnerText = SepFunctions.LangText("Section Text:");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                var jSections = SepCommon.DAL.CustomFields.Section_Get(SepFunctions.toLong(SepCommon.SepCore.Request.Item("SectionID")));

                if (jSections.SectionID == 0)
                {
                ...
                else
                {
                    ...
                    SectionName.Value = jSections.SectionName;
                    SectionText.Text = jSections.SectionText;
                }
            }
            else
            {
        ...
        {
            var sReturn = SepCommon.DAL.CustomFields.Section_Save(SepFunctions.toLong(SectionID.Value), SectionName.Value, SectionText.Text, 0);
