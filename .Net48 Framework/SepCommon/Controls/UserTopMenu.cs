...
namespace SepCityControls
{
    ...
    public class UserTopMenu
    {
        ...
        public string Render()
        {
            ...
            int ModuleID = SepFunctions.toInt(SepCommon.SepCore.Session.getSession("ModuleID"));
            var CategoryID = SepFunctions.toLong(SepCommon.SepCore.Request.Item("CatID"));
            ...
            switch (ModuleID)
            {
                ...
                case 33:
                    ...
                    if (SepFunctions.ModuleActivated(973) && SepFunctions.Setup(33, "ShowCreditsSignup") != "No")
                    {
                        using (SqlConnection conn = new SqlConnection(SepFunctions.Database_Connection()))
                        {
                            conn.Open();
                    ...
                    if (!string.IsNullOrWhiteSpace(SepFunctions.Session_User_ID()) && SepFunctions.Setup(33, "PPShowOrders") != "No")
                    {
                        using (SqlConnection conn = new SqlConnection(SepFunctions.Database_Connection()))
                        {
                            conn.Open();
                    ...
                    if (SepFunctions.Setup(2, "AdsEnable") == "Enable" && SepFunctions.Setup(33, "PPShowAdStats") != "No" && SepFunctions.Setup(2, "AdsStatsEnable") == "Yes" && SepFunctions.CompareKeys(SepFunctions.Security("AdsStats"), true))
                    {
                        using (SqlConnection conn = new SqlConnection(SepFunctions.Database_Connection()))
                        {
                            conn.Open();
                    ...
                    if (SepFunctions.Setup(33, "FriendsEnable") == "Yes" && SepFunctions.Setup(33, "PPShowFriends") != "No")
                    {
                    ...
                    if (SepFunctions.Setup(33, "PPShowFavorites") != "No")
                    {
                    ...
                    // === Start Affiliate
                    if (SepFunctions.Setup(17, "AffiliateEnable") == "Enable" && SepFunctions.Setup(33, "PPShowAffiliate") != "No" && SepFunctions.ModuleActivated(39))
                    {
                        using (SqlConnection conn = new SqlConnection(SepFunctions.Database_Connection()))
                        {
                            conn.Open();
                    ...
                    // === End Affiliate
                    if (SepFunctions.Setup(17, "MessengerEnable") == "Enable" && SepFunctions.Setup(33, "PPShowMessenger") != "No")
                    {
                    ...
                    if (!string.IsNullOrWhiteSpace(SepFunctions.Session_User_ID()) && SepFunctions.Setup(33, "PPShowProfile") != "No" && SepFunctions.Setup(63, "ProfilesEnable") == "Enable" && SepFunctions.ModuleActivated(63))
                    {
                        using (SqlConnection conn = new SqlConnection(SepFunctions.Database_Connection()))
                        {
                            conn.Open();
                    ...
                    if (SepFunctions.Setup(61, "BlogsEnable") == "Enable" && SepFunctions.Setup(33, "PPShowBlogs") != "No" && SepFunctions.ModuleActivated(61))
                    {
                    ...
                    if (SepFunctions.Setup(12, "ForumsEnable") == "Enable" && SepFunctions.Setup(33, "PPShowForums") != "No" && SepFunctions.ModuleActivated(12))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(strSql, conn))
                        {
                            using (SqlDataReader RS = cmd.ExecuteReader())
                            {
                                if (RS.HasRows)
                                {
                                    while (RS.Read())
                                    {
                                        string GetAcctPageName = SepFunctions.openNull(RS["UserPageName"]); ;
                                        if (SepFunctions.toLong(SepFunctions.openNull(RS["PageID"])) == 200)
                                        {
                                            GetAcctPageName += "?ID=" + SepFunctions.openNull(RS["UniqueID"]);
                                        }
                ...
                case 35:
                    ...
                    {
                        output.AppendLine("<li class=\"nav-item\"><a class=\"nav-link\" href=\"" + sInstallFolder + "article_display.aspx?DoAction=Print&ArticleID=" + SepFunctions.UrlEncode(SepCommon.SepCore.Request.Item("ArticleID")) + "\" target=\"_blank\"><i class=\"fa fa-print\"></i> " + SepFunctions.LangText("Print this Article") + "</a></li>");
                    }

                    if (!string.IsNullOrWhiteSpace(SepCommon.SepCore.Request.Item("ArticleID")) && SepFunctions.CompareKeys(GetManageKeys, true))
                    {
                        output.AppendLine("<li class=\"nav-item\"><a class=\"nav-link\" href=\"" + sInstallFolder + "articles_modify.aspx?ArticleID=" + SepFunctions.UrlEncode(SepCommon.SepCore.Request.Item("ArticleID")) + "\"><i class=\"fa fa-plus\"></i> " + SepFunctions.LangText("Edit Article") + "</a></li>");
                    }
                ...
                case 46:
                    ...
                    output.AppendLine("<li class=\"nav-item\"><a class=\"nav-link\" href=\"" + sInstallFolder + "events_modify.aspx?EventDate=" + SepFunctions.UrlEncode(SepCommon.SepCore.Request.Item("EventDate")) + "\"><i class=\"fa fa-plus\"></i> " + SepFunctions.LangText("Post Event") + "</a></li>");
                    if (SepFunctions.Setup(993, "RSSTop") == "Yes")
                    {
                ...
                case 999:
                    if (!string.IsNullOrWhiteSpace(SepCommon.SepCore.Request.Item("UniqueID")))
                    {
                        if (SepFunctions.CompareKeys(SepFunctions.Security("AdminEditPage"), true))
                        {
                            if (SepFunctions.Get_Portal_ID() == 0)
            ...
            if (ModuleID != 33 && showMenu && ModuleID != 17)
            {
                ...
                {
                    output.AppendLine("<li class=\"nav-item\"><a class=\"nav-link\" href=\"" + sInstallFolder + "refer.aspx?URL=" + SepFunctions.UrlEncode("/" + GetPageName + SepCommon.SepCore.Request.Url.Query()) + "&ModuleID=" + ModuleID + "\"><i class=\"fa fa-envelope\"></i> " + SepFunctions.LangText("Refer a Friend") + "</a></li>");
                }
                ...
                if (SepFunctions.Setup(993, "FavoritesTop") != "No")
                {
                    ...
                    {
                        string saveButton = "<button type=\"button\" class=\"btn btn-primary\" data-dismiss=\"saveButtonmodal\" onclick=\"saveFavorite('" + CategoryID + "', '" + ModuleID + "', '" + SepFunctions.UrlEncode(GetPageName + Strings.ToString(!string.IsNullOrWhiteSpace(SepCommon.SepCore.Request.Url.Query()) ? SepCommon.SepCore.Request.Url.Query() + "&" : "?") + "ModuleID=" + ModuleID) + "');$(this).hide();\">" + SepFunctions.LangText("Save") + "</button>";
