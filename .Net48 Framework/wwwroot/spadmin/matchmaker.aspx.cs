...
// ***********************************************************************
// <copyright file="matchmaker.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class matchmaker : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (SepFunctions.Admin_Login_Required(SepFunctions.Security("MatchAdmin")))
            {
            ...
            if (SepFunctions.CompareKeys(SepFunctions.Security("MatchAdmin"), true) == false)
            {
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.MatchMaker.Profile_Delete(sIDs);
        ...
        {
            var dMatchmakerProfiles = SepCommon.DAL.MatchMaker.GetMatchmakerProfiles(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value);

            dv = new DataView(SepFunctions.ListToDataTable(dMatchmakerProfiles));
            return dv;
        }
