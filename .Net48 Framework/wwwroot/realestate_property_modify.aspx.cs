...
// ***********************************************************************
// <copyright file="realestate_property_modify.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class realestate_property_modify.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class realestate_property_modify : Page
    {
        /// <summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                var jProperties = SepCommon.DAL.RealEstate.Property_Get(SepFunctions.toLong(SepCommon.SepCore.Request.Item("PropertyID")));
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            ErrorMessage.InnerHtml = Globals.GetSaveMessage(Master, GlobalVars.ModuleID, intReturn, PropertyTitle.Value);
        }
    }
}