...
// ***********************************************************************
// <copyright file="member_errors.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class member_errors : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No members errors have been recorded.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        {
            var dMemberErrors = SepCommon.DAL.Members.GetMemberErrors(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value);

            dv = new DataView(SepFunctions.ListToDataTable(dMemberErrors));
            return dv;
        }
