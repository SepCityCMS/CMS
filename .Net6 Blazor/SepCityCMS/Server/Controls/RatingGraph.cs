...
namespace SepCityCMS.Server.Controls
{
    ...
    public class RatingGraph
    {
        ...
        public long Rating_Adverage(long intStars1, long intStars2, long intStars3, long intStars4, long intStars5)
        {
            ...
            intTotalStars = intStars1 + intStars2 + intStars3 + intStars4 + intStars5;
        ...
        public string Render()
        {
            ...
            double selStar5Size = 0;
            double selStar4Size = 0;
            double selStar3Size = 0;
            double selStar2Size = 0;
            double selStar1Size = 0;
                ...
                using (SqlCommand cmd = new SqlCommand("SELECT Stars FROM Ratings WHERE ModuleID=@ModuleID AND UniqueID=@UniqueID", conn))
                {
                    ...
                    using (SqlDataReader RS = cmd.ExecuteReader())
                    {
                        while (RS.Read())
                        {
                            ...
                            {
                                case 5:
                                    selStars5 = selStars5 + 1;
                                    break;

                                case 4:
                                    selStars4 = selStars4 + 1;
                                    break;

                                case 3:
                                    selStars3 = selStars3 + 1;
                                    break;

                                case 2:
                                    selStars2 = selStars2 + 1;
                                    break;

                                case 1:
                                    selStars1 = selStars1 + 1;
                                    break;
                            }
                        }
                    }
            ...
            {
                DivideSize = 100 / (double)intTotalRecords;

                selStar5Size = selStars5 * DivideSize;
                selStar4Size = selStars4 * DivideSize;
                selStar3Size = selStars3 * DivideSize;
                selStar2Size = selStars2 * DivideSize;
                selStar1Size = selStars1 * DivideSize;
