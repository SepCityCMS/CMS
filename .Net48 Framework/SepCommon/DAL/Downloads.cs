...
namespace SepCommon.DAL
{
    ...
    public static class Downloads
    {
        ...
        public static string Download_Change_Status(string DownloadIDs, int Status)
        {
            ...
            return SepFunctions.LangText("File(s) status has been successfully saved.");
        }
        ...
        public static string Download_Delete(string DownloadIDs)
        {
            ...
            return SepFunctions.LangText("File(s) has been successfully deleted.");
        }
                    ...
                    using (SqlDataReader RS = cmd.ExecuteReader())
                    {
                        if (RS.HasRows)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    string[] arrFileExistions = Strings.Split(FileExtsntions, ",");
