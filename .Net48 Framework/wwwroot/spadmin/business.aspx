<%@ page title="Business Directory" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="business.aspx.cs" inherits="wwwroot.business" %>
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <div class="panel panel-default" id="PageManageGridView" runat="server">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                Eval("BusinessID").ToString()%>" value="<%#
                Eval("BusinessID").ToString()%>" onclick="gridviewSelectRow(this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:templatefield ItemStyle-Width="20px">
                        <itemtemplate>
                            <a href="business_modify.aspx?CatID=<%#
                Eval("CatID").ToString()%>&BusinessID=<%#
                Eval("BusinessID").ToString()%>">
