...
// ***********************************************************************
// <copyright file="downloads_view_photo.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class downloads_view_photo.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class downloads_view_photo : Page
    {
        /// <summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(SepCommon.SepCore.Request.Item("FileID")))
            {
                ...
                else
                {
                    ...
                    PictureUrl.ImageUrl = SepFunctions.GetDirValue("downloads", true) + jDownloads.FileName;
                    Caption.InnerHtml = jDownloads.Field1;
                }
            }
            else
            {
