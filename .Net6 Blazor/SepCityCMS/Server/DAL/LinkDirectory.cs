...
namespace SepCityCMS.Server.DAL
{
    ...
    public static class LinkDirectory
    {
        ...
        public static List<LinksWebsite> GetLinksWebsite(string SortExpression = "LinkName", string SortDirection = "ASC", string searchWords = "", long CategoryId = -1, string UserID = "", string StartDate = "")
        {
            ...
            {
                wClause += " AND Mod.DatePosted > '" + SepFunctions.FixWord(StartDate) + "'";
            }
            ...
            using (var ds = new DataSet())
            {
                ...
                {
                    using (var cmd = new SqlCommand("SELECT Mod.LinkID,Mod.CatID,Mod.LinkName,Mod.LinkURL,Mod.Description,Mod.Status,Mod.DatePosted FROM LinksWebsites AS Mod" + SepFunctions.Category_SQL_Manage_Select(CategoryId, wClause) + " ORDER BY " + SortExpression + " " + SortDirection, conn))
                    {
        ...
        public static string Website_Change_Status(string LinkIDs, int Status)
        {
            ...
            sReturn = SepFunctions.LangText("Website(s) status has been successfully saved.");
        ...
        public static string Website_Delete(string LinkIDs)
        {
            ...
            sReturn = SepFunctions.LangText("Website(s) has been successfully deleted.");
