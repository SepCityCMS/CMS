function getTxt(s) {
    switch (s) {
        case "Cannot delete Asset Base Folder.":
            return "Der Hauptordner kann nicht gel\u00F6scht werden.";
        case "Delete this file ?":
            return "Soll diese Datei gel\u00F6scht werden ?";
        case "Uploading...":
            return "Es wird hochgeladen...";
        case "File already exists. Do you want to replace it?":
            return "Datei existiert bereits. Soll sie ersetzt werden?";
        case "Files":
            return "Dateien";
        case "del":
            return "l&ouml;schen";
