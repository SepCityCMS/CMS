<%@ page language="C#" viewstatemode="Enabled" masterpagefile="~/skins/template.master"
    codebehind="messenger_blocked_users.aspx.cs" inherits="wwwroot.messenger_blocked_users" %>
...
<asp:content id="BodyContent" contentplaceholderid="SiteContent" runat="Server">
    ...
    <p align="center">
        Add a User:
         <input type="text" id="Username" runat="server" class="ignore" />
        <asp:Button ID="AddUserButton" runat="server" Text="Go" OnClick="AddUserButton_Click" />
    </p>
                ...
                <div class="col-lg-6">
                    <div class="input-group">
                        <select id="FilterDoAction" runat="server" class="form-control" clientidmode="Static">
                            ...
                            <option value="UnblockUsers">Un-block User(s)</option>
                        </select>
                        <span class="input-group-btn">
                            <button class="btn btn-light" id="RunAction" runat="server" onserverclick="RunAction_Click" onclick="if(ExecuteAction(this, 'BlockID') == false) {return false} else">Go!</button>
                        </span>
                    </div>
                </div>
                <div class="col-lg-6">
