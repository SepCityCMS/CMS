...
// ***********************************************************************
// <copyright file="changelog.aspx.cs" company="SepCity, Inc.">
    ...
    public partial class changelog : Page
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                {
                    DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("The change logs are currently empty.") + "</div>";
        ...
        {
            var sChangeLog = SepCommon.DAL.ChangeLog.GetChangeLogs(SepFunctions.toInt(SepCommon.SepCore.Request.Item("ModuleID")));

            dv = new DataView(SepFunctions.ListToDataTable(sChangeLog));
            return dv;
        }
    }
}