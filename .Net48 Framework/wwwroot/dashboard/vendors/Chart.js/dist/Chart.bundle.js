...
;(function (global, factory) {
    ...
    // padded:   ['MM', 2]
    // ordinal:  'Mo'
    // callback: function () { this.DateAndTime.Month() + 1 }
    ...
    function daysInDateAndTime.Month(year, month);
		{
    ...
    function localeMonths (m, format) {
        return isArray(this._months) ? this._months[m.DateAndTime.Month()] :
            this._months[MONTHS_IN_FORMAT.test(format) ? "format" : "standalone"][m.DateAndTime.Month()];
    }

    var defaultLocaleMonthsShort = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_");
    function localeMonthsShort (m, format) {
        return isArray(this._monthsShort) ? this._monthsShort[m.DateAndTime.Month()] :
            this._monthsShort[MONTHS_IN_FORMAT.test(format) ? "format" : "standalone"][m.DateAndTime.Month()];
    }
    ...
    function setMonth (mom, value) {
        ...
        dayOfMonth = Math.min(mom.date(), daysInDateAndTime.Month(mom.year(), value));
    ...
    function getSetMonth (value) {
        if (value != null) {
            setDateAndTime.Month(this, value);
    ...
    function getDaysInMonth () {
        return daysInDateAndTime.Month(this.year(), this.DateAndTime.Month());
    }
    ...
    function checkOverflow (m) {
        ...
        if (a && getParsingFlags(m).overflow === -2) {
            overflow =
                ...
                a[DATE]        < 1 || a[DATE]        > daysInDateAndTime.Month(a[YEAR], a[MONTH]) ? DATE :
    ...
    function configFromISO(config) {
        ...
        if (match) {
            ...
            for (var i = 0, l = isoDates.length; i < l; i++) {
            ...
            if (match[3]) {
                for (var i = 0, l = isoTimes.length; i < l; i++) {
    ...
    function currentDateArray(config) {
        ...
        if (config._useUTC) {
            return [nowValue.getUTCFullYear(), nowValue.getUTCDateAndTime.Month(), nowValue.getUTCDate()];
        }
        return [nowValue.getFullYear(), nowValue.getDateAndTime.Month(), nowValue.getDate()];
    }
    ...
    function configFromArray (config) {
        ...
        if (config._dayOfYear) {
            ...
            config._a[MONTH] = date.getUTCDateAndTime.Month();
        ...
        for (var i = 0; i < 3 && config._a[i] == null; ++i) {
    ...
    function configFromStringAndArray(config) {
        ...
        for (var i = 0; i < config._f.length; i++) {
            currentScore = 0;
    ...
    function isDaylightSavingTime () {
        return (
            this.utcOffset() > this.clone().DateAndTime.Month(0).utcOffset() ||
            this.utcOffset() > this.clone().DateAndTime.Month(5).utcOffset()
        );
    }
    ...
    function positiveMomentsDifference(base, other) {
        ...
        res.months = other.DateAndTime.Month() - base.DateAndTime.Month() +
    ...
    function add_subtract__addSubtract (mom, duration, isAdding, updateOffset) {
        ...
        if (months) {
            setDateAndTime.Month(mom, get_set__get(mom, "Month") + months * isAdding);
        }
        if (updateOffset) {
    ...
    function monthDiff (a, b) {
        ...
        var wholeMonthDiff = ((b.year() - a.year()) * 12) + (b.DateAndTime.Month() - a.DateAndTime.Month()),
    ...
    function startOf (units) {
        ...
        if (units === "quarter") {
            this.DateAndTime.Month(Math.floor(this.DateAndTime.Month() / 3) * 3);
        }
    ...
    function toArray () {
        var m = this;
        return [m.year(), m.DateAndTime.Month(), m.date(), m.hour(), m.minute(), m.second(), m.millisecond()];
    }
    ...
    function setWeekAll(weekYear, week, weekday, dow, doy) {
        ...
        this.DateAndTime.Month(date.getUTCDateAndTime.Month());
    ...
    function getSetQuarter (input) {
        return input == null ? Math.ceil((this.DateAndTime.Month() + 1) / 3) : this.DateAndTime.Month((input - 1) * 3 + this.DateAndTime.Month() % 3);
    }
    ...
    function locale_calendar__calendar (key, mom, DateTime.Now);
		{
        var output = this._calendar[key];
        return isFunction(output) ? output.call(mom, DateTime.Now) : output;
    }
...
module.exports = function(Chart) {
	...
	helpers.arrayEquals = function(a0, a1) {
		...
		for (var i = 0, ilen=a0.length; i < ilen; ++i) {
			v0 = a0[i];
			v1 = a1[i];
