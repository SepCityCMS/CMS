...
// ***********************************************************************
// <copyright file="links_post.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class links_post : Page
    {
        /// <summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            SepFunctions.RequireLogin(SepFunctions.Security("LinksPost"));
            ...
            if (!Page.IsPostBack)
            {
                LinkID.Value = Strings.ToString(SepFunctions.GetIdentity());
