<%@ page title="Shopping Mall Stores" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="shopstores.aspx.cs" inherits="wwwroot.shopstores" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Manage Stores"></span>
        </h2>
						...
						<div class="input-group">
							<select id="FilterDoAction" runat="server" class="form-control" ClientIDMode="Static">
								<option value="">Select an Action</option>
									<option value="DeleteStored">Delete Stores</option>
                    </select>
							<span class="input-group-btn">
							<button class="btn btn-light" ID="RunAction" runat="server" OnServerClick="RunAction_Click" onclick="if(ExecuteAction(this, 'StoreID') == false) {return false} else">Go!</button>
						</span>
					</div>
				</div>
				<div class="col-lg-6">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    <asp:TemplateField ItemStyle-Width="20px">
                        ...
                        <ItemTemplate>
                            <input type="checkbox" id="StoreID<%#
                Eval("StoreID").ToString()%>" value="<%#
                Eval("StoreID").ToString()%>" onclick="gridviewSelectRow(this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:templatefield ItemStyle-Width="20px">
                        <itemtemplate>
                            <a href="shopstores_modify.aspx?StoreID=<%#
                Eval("StoreID").ToString()%>">
                                <img src="../images/public/edit.png" alt="Edit" />
                            </a>
                        </itemtemplate>
                    </asp:templatefield>
                    <asp:TemplateField HeaderText="Store Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="StoreName">
                        <ItemTemplate>
                            <%#
                Eval("StoreName").ToString()%>
                        </ItemTemplate>
                    </asp:TemplateField>
                ...
                Eval("CompanyName").ToString()%>
                    ...
                    <asp:TemplateField HeaderText="View Orders" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top">
                        <ItemTemplate>
                            <a href="shopstores_orders.aspx?StoreID=<%# Eval("StoreID").ToString()%>">View Orders</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
