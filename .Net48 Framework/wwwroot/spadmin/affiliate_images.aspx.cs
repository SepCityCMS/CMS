...
// ***********************************************************************
// <copyright file="affiliate_images.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class affiliate_images.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class affiliate_images : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Images");
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Image");
                }
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No affiliate images have been added.") + "</div>";
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.Affiliate.Image_Delete(sIDs);
        ...
        {
            var dAffiliateImages = SepCommon.DAL.Affiliate.GetAffiliateImages();

            dv = new DataView(SepFunctions.ListToDataTable(dAffiliateImages));
            return dv;
        }
    }
}