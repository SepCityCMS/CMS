...
namespace SepCommon.DAL
{
    ...
    public static class Affiliate
    {
        ...
        public static string Affiliate_Reset(string AffiliateIDs)
        {
            ...
            return SepFunctions.LangText("Affiliate(s) has been successfully reset.");
        }
        ...
        public static List<AffiliateDownline> AffiliateTotals()
        {
            ...
            double TotalVolume1 = SepFunctions.Format_Double(Strings.ToString(SepFunctions.PUB_Affiliate_Five_Level_Sales(sAffiliateID, ref TotalEarnings1, 1)));
            double TotalVolume2 = SepFunctions.Format_Double(Strings.ToString(SepFunctions.PUB_Affiliate_Five_Level_Sales(sAffiliateID, ref TotalEarnings2, 2)));
        ...
        public static List<AffiliateMembers> GetAffiliateMembers(string SortExpression = "Username", string SortDirection = "ASC", string searchWords = "")
        {
            ...
            SqlStr += " where root.AffiliateID <> '' AND root.Status <> -1 AND (AffiliateID IN (SELECT AffiliateID FROM Invoices WHERE Status=1) OR ReferralID=AffiliateID)";
            ...
            using (var ds = new DataSet())
            {
                ...
                for (var i = 0; i <= ds.Tables[0].Rows.Count - 1; i++)
                {
                    ...
                    double AffiliatePayout = 0;
                    double RevenueGenerated = SepFunctions.PUB_Affiliate_Five_Level_Sales(SepFunctions.toLong(SepFunctions.openNull(ds.Tables[0].Rows[i]["AffiliateID"])), ref AffiliatePayout, 1) + SepFunctions.PUB_Affiliate_Five_Level_Sales(SepFunctions.toLong(SepFunctions.openNull(ds.Tables[0].Rows[i]["AffiliateID"])), ref AffiliatePayout, 2);
        ...
        public static string Image_Delete(string ImageIDs)
        {
            ...
            return SepFunctions.LangText("Image(s) has been successfully deleted.");
        }
        ...
        public static string Image_Save(long ImageID, string UserID, int ModuleID, string FileName, string ImageData, string ImageType, long PortalID)
        {
            ...
            string sReturn = SepFunctions.LangText("Affiliate image has been successfully added.");
