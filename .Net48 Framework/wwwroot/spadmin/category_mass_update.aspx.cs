...
// ***********************************************************************
// <copyright file="category_mass_update.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class category_mass_update.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class category_mass_update : Page
    {
        /// <summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    ModifyLegend.InnerHtml = SepFunctions.LangText("Mass Update");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                AccessKeysRow.Visible = false;
                WriteKeysRow.Visible = false;
                ManageKeysRow.Visible = false;
            }

            CatIDs.Value = SepCommon.SepCore.Request.Item("CatIDs");
        }
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            var arrCatIds = Strings.Split(CatIDs.Value, ",");

            if (arrCatIds != null)
            {
                for (var i = 0; i <= Information.UBound(arrCatIds); i++) sReturn = SepCommon.DAL.Categories.Category_Mass_Save(SepFunctions.toLong(arrCatIds[i]), Request.Form["Modules"], Request.Form["AccessKeysSelection"], AccessKeysHide.Checked, Request.Form["WriteKeysSelection"], AccessKeysHide.Checked, Request.Form["ManageKeysSelection"], PortalSelection.Text, ShareContent.Checked, ExcludePortalSecurity.Checked);
            }
