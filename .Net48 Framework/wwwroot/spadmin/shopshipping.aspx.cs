...
// ***********************************************************************
// <copyright file="shopshipping.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class shopshipping : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        {
            var dShopShipping = SepCommon.DAL.ShoppingMall.GetShopShippingMethods(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value, 0);
