...
// ***********************************************************************
// <copyright file="downloads_view_video.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class downloads_view_video.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class downloads_view_video : Page
    {
        /// <summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (SepCommon.SepCore.Request.Item("Shared") != "Yes") SepFunctions.RequireLogin(SepFunctions.Security("LibraryAccess"));
            ...
            if (SepCommon.SepCore.Request.Item("Shared") == "Yes")
            {
                VideoContent.Visible = false;
                ShareDiv.Visible = false;
            }
            ...
            if (!string.IsNullOrWhiteSpace(SepCommon.SepCore.Request.Item("FileID")))
            {
                ...
                else
                {
                    ...
                    ShareHTML.Value = "<div class=\"embed-responsive embed-responsive-4by3\"><iframe class=\"embed-responsive-item\" src=\"" + SepFunctions.GetMasterDomain(true) + "downloads_view_video.aspx?FileID=" + jDownloads.FileID + "&Shared=Yes\" frameborder=\"0\" scrolling=\"no\"></iframe></div>";
                }
            }
            else
            {
        ...
        protected override void OnPreInit(EventArgs e)
        {
            ...
            if (SepCommon.SepCore.Request.Item("Shared") != "Yes") Page.MasterPageFile = SepFunctions.GetMasterPage();
