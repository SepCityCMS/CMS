...
namespace SepCommon
{
    ...
    public class ChatProvider : CuteChat.ChatProvider // -V3072
    {
        ...
        {
            return SepFunctions.Session_User_Name();
        }
        ...
        {
            return SepFunctions.Database_Connection();
        }
        ...
        {
            var loginname = SepFunctions.Session_User_Name();
            var nickname = SepFunctions.Session_User_Name();
        ...
        {
            nickName = SepFunctions.Session_User_Name();

            if (SepFunctions.CompareKeys("|2|"))
            {
                isAdmin = true;
            }
            else
