...
// ***********************************************************************
// <copyright file="photoalbums.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class photoalbums : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    ManageGridView.Columns[3].HeaderText = SepFunctions.LangText("Album Name");
        ...
        {
            var dPhotoAlbums = SepCommon.DAL.PhotoAlbums.GetPhotoAlbums(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value);
