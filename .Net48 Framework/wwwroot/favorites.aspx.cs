...
// ***********************************************************************
// <copyright file="favorites.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class favorites : Page
    {
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Favorite(s)");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                SepCommon.SepCore.Session.setCookie("returnUrl", SepFunctions.GetInstallFolder() + "favorites.aspx");
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("You currently do not have any favorites.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        {
            var dFavorites = SepCommon.DAL.Favorites.GetFavorites(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value, SepFunctions.Session_User_ID());
