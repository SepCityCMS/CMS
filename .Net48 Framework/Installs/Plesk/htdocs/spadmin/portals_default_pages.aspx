<%@ page title="Default Web Pages" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="portals_default_pages.aspx.cs" inherits="wwwroot.portals_default_pages" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Default Web Pages"></span>
        </h2>
