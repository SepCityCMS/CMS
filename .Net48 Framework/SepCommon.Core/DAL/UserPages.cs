...
namespace SepCommon.Core.DAL
{
    ...
    public static class UserPages
    {
        ...
        public static string Guestbook_Delete(string UserID, string EntryIDs)
        {
            ...
            sReturn = SepFunctions.LangText("Entry(s) has been successfully deleted.");
        ...
        public static string Guestbook_Save(long EntryID, string UserID, string EmailAddress, string SiteURL, string Message)
        {
            ...
            sReturn = SepFunctions.LangText("Entry has been successfully added.");
        ...
        public static string Page_Delete(string UserID, string PageIDs)
        {
            ...
            sReturn = SepFunctions.LangText("Web Page(s) has been successfully deleted.");
        ...
        public static int Save_Web_Page(long PageID, string UserID, int MenuID, string PageTitle, string PageText, long TemplateID, long Weight, string PagePassword)
        {
            ...
            PageName = Strings.LCase(SepFunctions.ReplaceSpecial(SepFunctions.RemoveHTML(Strings.Replace(PageTitle, " ", string.Empty)))) + ".aspx";
            ...
            intReturn = SepFunctions.Additional_Data_Save(isNewRecord, 7, Strings.ToString(PageID), UserID, SepFunctions.GetUserInformation("UserName", UserID), "WebPage", "Web Page", string.Empty);
        ...
        public static int Save_Web_Site(long SiteID, long CatID, string UserID, string SiteName, string SiteSlogan, string Description, long TemplateID, bool ShowList, bool InviteOnly, bool EnableGuestbook, long PortalID)
        {
            ...
            intReturn = SepFunctions.Additional_Data_Save(isNewRecord, 7, Strings.ToString(SiteID), UserID, SepFunctions.GetUserInformation("UserName", UserID), "WebSite", "Web Site", "CreateSite");
