...
namespace wwwroot
{
    ...
    public partial class activation1 : Page
    {
        /// <summary>
        ...
        protected void ContinueButton_Click(object sender, EventArgs e)
        {
            ...
            {
                var jActivation = soapClient.Get_License_Details(UserName.Value, SepFunctions.MD5Hash_Encrypt(Password.Value), LicenseKey.Value);
                ...
                try
                {
                    if (jActivation.Status == "Active")
                    {
                        ...
                        Session["LicensePass"] = SepFunctions.MD5Hash_Encrypt(Password.Value);
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            Label menuLabel = (Label)Master.FindControl("ActSpan");
            if (menuLabel != null)
                menuLabel.Font.Bold = true;

            if (Session["DBAddress"] == null || Session["DBName"] == null || Session["DBUser"] == null || Session["DBPass"] == null) contentactinfo.InnerHtml = "<div class=\"alert alert-danger\" role=\"alert\">Missing Database Information, please run the install again.</div>";

            if (Session["PUserName"] == null || Session["PPassword"] == null || Session["PSecretQuestion"] == null || Session["PSecretAnswer"] == null || Session["PEmailAddress"] == null || Session["PFirstName"] == null || Session["PLastName"] == null || Session["PCountry"] == null || Session["PStreetAddress"] == null || Session["PCity"] == null || Session["PPostalCode"] == null || Session["PGender"] == null || Session["PBirthDate"] == null || Session["PPhoneNumber"] == null) contentactinfo.InnerHtml = "<div class=\"alert alert-danger\" role=\"alert\">Missing personal Information, please run the install again.</div>";

            if (Session["SMTPServer"] == null) contentactinfo.InnerHtml = "<div class=\"alert alert-danger\" role=\"alert\">Missing SMTP Information, please run the install again.</div>";
        }
    }
}