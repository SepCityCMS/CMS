<%@ page title="Group Lists" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="group_lists.aspx.cs" inherits="wwwroot.group_lists" %>
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <div class="panel panel-default" id="PageManageGridView" runat="server">
						...
						<div class="input-group">
							<select id="FilterDoAction" runat="server" class="form-control" ClientIDMode="Static">
								<option value="">Select an Action</option>
									<option value="DeleteGroupLists">Delete Group Lists</option>
                    </select>
							<span class="input-group-btn">
							<button class="btn btn-light" ID="RunAction" runat="server" OnServerClick="RunAction_Click" onclick="if(ExecuteAction(this, 'ListID') == false) {return false} else">Go!</button>
						</span>
					</div>
				</div>
				<div class="col-lg-6">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                Eval("ListID").ToString()%>" value="<%#
                Eval("ListID").ToString()%>" onclick="gridviewSelectRow(this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:templatefield ItemStyle-Width="20px">
                        <itemtemplate>
                            <a href="group_lists_modify.aspx?ListID=<%#
                Eval("ListID").ToString()%>">
                                <img src="../images/public/edit.png" alt="Edit" />
                            </a>
                        </itemtemplate>
                    </asp:templatefield>
                    <asp:TemplateField HeaderText="List Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="ListName">
                        <ItemTemplate>
                            <%#
                Eval("ListName").ToString()%>
                        </ItemTemplate>
                    </asp:TemplateField>
                ...
                Eval("Username").ToString()%>
                    ...
                    <asp:TemplateField HeaderText="View Users" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top">
                        <ItemTemplate>
                            <a href="group_lists_users.aspx?ListID=<%#
                Eval("ListID").ToString()%>">View</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
