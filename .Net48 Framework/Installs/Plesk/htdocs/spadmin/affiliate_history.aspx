<%@ page title="Affiliate" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="affiliate_history.aspx.cs" inherits="wwwroot.affiliate_history" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Affiliate User Payment History"></span>
        </h2>
        ...
        <div class="GridViewStyle">
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Amount Paid" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="AmountPaid">
                        <ItemTemplate>
                            <%#
                Eval("AmountPaid")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Date Paid" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="DatePaid">
                        <ItemTemplate>
                            <%#
                Eval("DatePaid")%>
                        </ItemTemplate>
