...
namespace SepCityCMS.Server.Controls
{
    ...
    public class WYSIWYGEditor
    {
        ...
        public string Mode
        {
            get => SepCore.Strings.ToString(m_Mode);
        ...
        public string Text
        {
            get
            {
                var s = SepCore.Request.Form("txt" + ID);
                if (s == null)
                {
        ...
        public string Render()
        {
            ...
            output.AppendLine("\"autoresize advlist autolink autosave link sepimage" + SepCore.Strings.ToString(Mode == "advanced" ? " sepinsert" : string.Empty) + SepCore.Strings.ToString(Mode == "userpage" ? " sepinsert2" : string.Empty) + " lists charmap\",");
            ...
            if (SepCore.Request.Browser.IsMobileDevice())
            {
            ...
            {
                output.AppendLine("toolbar1: \"cut copy paste | undo redo | searchreplace | fontselect fontsizeselect | indent outdent link charmap" + SepCore.Strings.ToString(Mode == "advanced" ? " sepinsert" : string.Empty) + SepCore.Strings.ToString(Mode == "userpage" ? " sepinsert2" : string.Empty) + "\",");
