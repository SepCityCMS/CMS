<%@ page title="Search Optimization" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="search_meta_tags.aspx.cs" inherits="wwwroot.search_meta_tags" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Manage the Meta Tags"></span>
        </h2>
        ...
        <div class="panel panel-default" id="PageManageGridView" runat="server">
						...
						<div class="input-group">
							<select id="FilterDoAction" runat="server" class="form-control" ClientIDMode="Static">
								<option value="">Select an Action</option>
									<option value="DeleteMetaTag">Delete Meta Tag</option>
                    </select>
							<span class="input-group-btn">
							<button class="btn btn-light" ID="RunAction" runat="server" OnServerClick="RunAction_Click" onclick="if(ExecuteAction(this, 'TagID') == false) {return false} else">Go!</button>
						</span>
					</div>
				</div>
				<div class="col-lg-6">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                          CssClass="GridViewStyle" OnSorting="ManageGridView_Sorting" EnableViewState="True">
                <Columns>
                ...
                Eval("TagID")%>" value="<%#
                Eval("TagID")%>" onclick="gridviewSelectRow(this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:templatefield ItemStyle-Width="20px">
                        <itemtemplate>
                            <a href="search_meta_tags_modify.aspx?TagID=<%#
                Eval("TagID")%>">
                ...
                Eval("PageTitle")%>
                    ...
                    <asp:TemplateField HeaderText="Page URL" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="PageURL">
                        <ItemTemplate>
                            <%#
                Eval("PageURL")%>
                        </ItemTemplate>
