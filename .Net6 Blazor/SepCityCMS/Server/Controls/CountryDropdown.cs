...
namespace SepCityCMS.Server.Controls
{
    ...
    public class CountryDropdown
    {
        ...
        public string Render()
        {
            ...
            var sStateBox = !string.IsNullOrWhiteSpace(StateDropdownID) ? "try{StateBox('" + Integrations.SepFunctions.SepCityToken() + "', $('#" + ID + "').val(), $('#" + StateDropdownID + "'));}catch(e){};" : string.Empty;
