<%@ page title="Guestbook" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="guestbook.aspx.cs" inherits="wwwroot.guestbook" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Manage the Guestbook"></span>
        </h2>
        ...
        <div class="panel panel-default" id="PageManageGridView" runat="server">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                Eval("EntryID").ToString()%>" value="<%#
                Eval("EntryID").ToString()%>" onclick="gridviewSelectRow(this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:templatefield ItemStyle-Width="20px">
                        <itemtemplate>
                            <a href="guestbook_modify.aspx?EntryID=<%#
                Eval("EntryID").ToString()%>">
                    ...
                    <asp:TemplateField HeaderText="Message" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="Message">
                        <ItemTemplate>
                            <%#
