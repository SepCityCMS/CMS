...
// ***********************************************************************
// <copyright file="realestate_my_properties.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class realestate_my_properties.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class realestate_my_properties : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public string Get_Property_Type(string PropertyType)
        {
            switch (SepFunctions.toInt(PropertyType))
            {
                case 2:
                    return SepFunctions.LangText("Condo");

                case 3:
                    return SepFunctions.LangText("House");

                case 4:
                    return SepFunctions.LangText("Land/Lot");

                case 5:
                    return SepFunctions.LangText("Town House");

                case 11:
                    return SepFunctions.LangText("Commercial Land/Lot");

                case 12:
                    return SepFunctions.LangText("Commercial Building (Buy)");

                case 13:
                    return SepFunctions.LangText("Commercial Building (Rent)");

                case 15:
                    return SepFunctions.LangText("Furnished Rooms (Rent)");

                default:
                    return SepFunctions.LangText("Apartment");
            }
        }
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Properties");
                    ManageGridView.Columns[1].HeaderText = SepFunctions.LangText("Title");
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Property Type");
                    ManageGridView.Columns[3].HeaderText = SepFunctions.LangText("City");
                    ManageGridView.Columns[4].HeaderText = SepFunctions.LangText("State");
                }
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            SepFunctions.RequireLogin(SepFunctions.Security("RStatePost"));
            ...
            if (SepFunctions.CompareKeys(SepFunctions.Security("RStateTenants"), false) == false) ManageGridView.Columns[6].Visible = false;
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No properties have been added.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.RealEstate.Property_Delete(sIDs);
        ...
        {
            var dRealEstateProperties = SepCommon.DAL.RealEstate.GetRealEstateProperties(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value, SepFunctions.Session_User_ID());
