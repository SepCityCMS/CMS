...
// ***********************************************************************
// <copyright file="email_templates.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class email_templates : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Email Templates");
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Template Name");
                    ManageGridView.Columns[3].HeaderText = SepFunctions.LangText("Email Subject");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No email templates have been added.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.EmailTemplates.Template_Delete(sIDs);
        ...
        {
            var dEmailTemplates = SepCommon.DAL.EmailTemplates.GetEmailTemplates(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value);

            dv = new DataView(SepFunctions.ListToDataTable(dEmailTemplates));
            return dv;
        }
