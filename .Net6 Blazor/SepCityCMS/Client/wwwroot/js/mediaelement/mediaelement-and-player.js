    ...
    silverlight: [
        {
            version: [3, 0],
            types: [
                "video/mp4", "video/m4v", "video/mov", "video/wmv", "audio/wma", "audio/m4a", "audio/mp3", "audio/wav",
                "audio/mpeg"
            ]
        }
    ],
    flash: [
        {
            version: [9, 0, 124],
            types: [
                "video/mp4", "video/m4v", "video/mov", "video/flv", "video/rtmp", "video/x-flv", "audio/flv",
                "audio/x-flv", "audio/mp3", "audio/m4a", "audio/mpeg", "video/youtube", "video/x-youtube"
            ]
        }
...
// Add Flash detection
mejs.PluginDetector.addPlugin("flash",
    "Shockwave Flash",
...
mejs.PluginDetector.addPlugin("silverlight",
    "Silverlight Plug-In",
    ...
    canPlayType: function(type) {
        ...
        for (var i = 0; i < pluginVersions.length; i++) {
            ...
            if (mejs.PluginDetector.hasPluginVersion(this.pluginType, pluginInfo.version)) {
                ...
                for (var j = 0; j < pluginInfo.types.length; j++) {
...
mejs.MediaElementDefaults = {
    ...
    pluginPath: mejs.Utility.getScriptPath([
        "mediaelement.js", "mediaelement.min.js", "mediaelement-and-player.js", "mediaelement-and-player.min.js"
    ]),
    // name of flash file
...
mejs.HtmlMediaElementShim = {
    create: function(el, o) {
        ...
        if (playback.method == "native") {
            ...
            if (mejs.MediaFeatures.isBustedAndroid) {
                ...
                htmlMediaElement.addEventListener("click",
                    function() {
    ...
    determinePlayback: function(htmlMediaElement, options, supportsMediaTag, isMediaTag, src) {
        ...
        if (typeof options.type != "undefined" && options.type !== "") {
            ...
            for (var i = 0; i < htmlMediaElement.childNodes.length; i++) {
    ...
    getTypeFromFile: function(url) {
        ...
        return (/(mp4|m4v|ogg|ogv|webm|webmv|flv|wmv|mpeg|mov)/gi.test(ext) ? "video" : "audio") +
            "/" +
    ...
    createPlugin: function(playback, options, poster, autoplay, preload, controls) {
        ...
        case "vimeo":
            ...
            container.innerHTML = '<iframe src="http://player.vimeo.com/video/' +
    ...
    createFlash: function(settings) {
        ...
        */
        ...
        var specialIEContainer,
            youtubeUrl = "//www.youtube.com/apiplayer?enablejsapi=1&amp;playerapiid=" +
                settings.pluginId +
            ...
            },
            {
                ...
                action: function(player, media) {
                    if (!isNaN(media.duration) && media.duration > 0) {
                        ...
                        // 5%
                        var newTime = Math.min(media.currentTime + player.options.defaultSeekForwardInterval(media),
                            media.duration);
                        media.setCurrentTime(newTime);
                    }
                }
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        setPlayerSize: function(width, height) {
            ...
            if (t.height.toString().indexOf("%") > 0 ||
                ...
                if (t.container.parent()[0].tagName
                    .toLowerCase() ===
                    "body") { // && t.container.siblings().count == 0) {
                ...
                .bind("mousedown",
                    function(e) {
                        ...
                        if (e.which === 1) {
                            mouseIsDown = true;
                            handleMouseMove(e);
                            t.globalBind("mousemove.dur",
                                function(e) {
                                    handleMouseMove(e);
                                });
                            t.globalBind("mouseup.dur",
                                function(e) {
                                    mouseIsDown = false;
                                    timefloat.hide();
                                    t.globalUnbind(".dur");
...
(function($) {
    ...
    $.extend(MediaElementPlayer.prototype,
    {
            ...
            if (controls.children().last().find(".mejs-currenttime").length > 0) {
                $(t.options.timeAndDurationSeparator +
                        ...
                        (t.options.duration > 0
                                ? mejs.Utility
                                .secondsToTimeCode(t.options.duration,
        ...
        updateCurrent: function() {
            ...
            if (t.currenttime) {
                t.currenttime.html(mejs.Utility
                    .secondsToTimeCode(t.media.currentTime,
                        t.options.alwaysShowHours || t.media.duration > 3600,
                        t.options.showTimecodeFrameCount,
                        t.options.framesPerSecond || 25));
            }
        ...
        updateDuration: function() {
            ...
            if (t.durationD && (t.options.duration > 0 || t.media.duration)) {
                t.durationD.html(mejs.Utility
                    .secondsToTimeCode(t.options.duration > 0 ? t.options.duration : t.media.duration,
        ...
        buildfullscreen: function(player, controls, layers, media) {
            ...
            if (t.media.pluginType === "native" || (!t.options.usePluginFullScreen && !mejs.MediaFeatures.isFirefox)) {
                ...
                fullscreenBtn.click(function() {
                    var isFullScreen = (mejs.MediaFeatures
                    ...
                    */
                    ...
                    var fullscreenIsDisabled = false,
                        ...
                        positionHoverDivs = function() {
                            ...
                            for (i in hoverDivs) {
                                hoverDivs[i]
                                    .css({ position: "absolute", top: 0, left: 0 }); //, backgroundColor: '#f00'});
                            }
                    ...
                    fullscreenBtn.on("mouseover",
                        function() {
                            ...
                            if (!t.isFullScreen) {
                                ...
                                media
                                    .positionFullscreenButton(buttonPos.left - containerPos.left,
                    ...
                    t.globalBind("mousemove",
                        function(e) {
                            ...
                            if (fullscreenIsDisabled) {
                                ...
                                if (e.pageY < fullscreenBtnPos.top ||
...
(function($) {
    ...
    $.extend(MediaElementPlayer.prototype,
    {
        ...
        buildtracks: function(player, controls, layers, media) {
            ...
            if (t.domNode
                .textTracks) { // if browser will do native captions, prefer mejs captions, loop through tracks and hide
        ...
        displayCaptions: function() {
            ...
            if (track != null && track.isLoaded) {
                for (var i = 0; i < track.entries.times.length; i++) {
        ...
        displaySlides: function() {
            ...
            for (var i = 0; i < slides.entries.times.length; i++) {
        ...
        drawChapters: function(chapters) {
            ...
            for (var i = 0; i < chapters.entries.times.length; i++) {
                ...
                t.chapters.append($(
                    ...
                    "</span>" +
                    '<span class="ch-time">' +
                    mejs.Utility.secondsToTimeCode(chapters.entries.times[i].start) +
                    "&ndash;" +
                    mejs.Utility.secondsToTimeCode(chapters.entries.times[i].stop) +
                    "</span>" +
                    "</div>" +
                    "</div>"));
                usedPercent += percent;
...
(function($) {
    ...
    $.extend(MediaElementPlayer.prototype,
    {
        buildcontextmenu: function(player, controls, layers, media) {
            ...
            player.container.bind("contextmenu",
                function(e) {
        ...
        renderContextMenu: function(x, y) {
            ...
            for (var i = 0, il = items.length; i < il; i++) {
                ...
                if (items[i].isSeparator) {
                    ...
                    if (rendered != null) {
                        html += '<div class="mejs-contextmenu-item" data-itemindex="' +
                            i +
                            '" id="element-' +
                            (Math.random() * 1000000) +
                            '">' +
