...
var numberParse = function(value, properties) {
    ...
    if (aux = value.match(infinitySymbol)) {
        ...
        localizedSymbolsRe = new RegExp(
            Object.keys(invertedSymbolMap)
            .map(function(localizedSymbol) {
        ...
        if (invertedNuDigitsMap) {
            ...
            localizedDigitRe = new RegExp(
                Object.keys(invertedNuDigitsMap)
                .map(function(localizedDigit) {
...
var numberParseProperties = function(pattern, cldr) {
    ...
    negativeProperties = numberPatternProperties(negativePattern);
    if (nuDigitsMap) {
        invertedNuDigitsMap = nuDigitsMap.split("")
            .reduce(function(object, localizedDigit, i) {
                object[localizedDigit] = String(i);
                return object;
            },
            {});
        invertedNuDigitsMapSanityCheck = "0123456789".split("")
            .reduce(function(object, digit) {
