<%@ page title="Content Rotator" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="contentrotator.aspx.cs" inherits="wwwroot.contentrotator" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Manage the Content Rotator"></span>
        </h2>
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="input-group">
							...
							<button class="btn btn-light" ID="RunAction" runat="server" OnServerClick="RunAction_Click" onclick="if(ExecuteAction(this, 'ContentID') == false) {return false} else">Go!</button>
						</span>
					</div>
				</div>
				<div class="col-lg-6">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    <asp:TemplateField ItemStyle-Width="20px">
                        ...
                        <ItemTemplate>
                            <input type="checkbox" id="ContentID<%#
                Eval("ContentID").ToString()%>" value="<%#
                Eval("ContentID").ToString()%>" onclick="gridviewSelectRow(this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:templatefield ItemStyle-Width="20px">
                        <itemtemplate>
                            <a href="contentrotator_modify.aspx?ContentID=<%#
                Eval("ContentID").ToString()%>">
