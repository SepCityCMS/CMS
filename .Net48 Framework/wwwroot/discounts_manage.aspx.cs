...
// ***********************************************************************
// <copyright file="discounts_manage.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class discounts_manage.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class discounts_manage : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    ManageGridView.Columns[1].HeaderText = SepFunctions.LangText("Label Text");
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Company Name");
                    ManageGridView.Columns[3].HeaderText = SepFunctions.LangText("Price");
                }
            }
        }
        ...
        {
            var dDiscounts = SepCommon.DAL.Discounts.GetDiscounts(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value, UserID: SepFunctions.Session_User_ID());
