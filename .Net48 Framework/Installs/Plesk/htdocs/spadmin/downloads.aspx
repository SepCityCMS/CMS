<%@ page title="Downloads" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="downloads.aspx.cs" inherits="wwwroot.downloads" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Manage the Downloads"></span>
        </h2>
        ...
        <div class="panel panel-default" id="PageManageGridView" runat="server">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                Eval("FileID").ToString()%>" value="<%#
                Eval("FileID").ToString()%>" onclick="gridviewSelectRow(this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:templatefield ItemStyle-Width="20px">
                        <itemtemplate>
                            <a href="downloads_modify.aspx?CatID=<%#
                Eval("CatID").ToString()%>&FileID=<%#
