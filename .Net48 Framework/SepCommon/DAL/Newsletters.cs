...
namespace SepCommon.DAL
{
    ...
    public static class Newsletters
    {
        ...
        public static string Newsletter_Delete(string LetterIDs)
        {
            ...
            return SepFunctions.LangText("Newsletter(s) has been successfully deleted.");
        }
        ...
        public static string Newsletter_Members_Delete(string UserIDs)
        {
            ...
            return SepFunctions.LangText("Newsletter user(s) has been successfully deleted.");
        }
        ...
        public static int Newsletter_Save(long LetterID, string UserID, string LetterName, string Description, string PortalIDs, string JoinKeys)
        {
            ...
            int intReturn = SepFunctions.Additional_Data_Save(isNewRecord, 24, Strings.ToString(LetterID), UserID, SepFunctions.GetUserInformation("UserName", UserID), "Newsletter", "Newsletter", string.Empty);
            if (intReturn == 0)
            {
                if (bUpdate)
                {
        ...
        public static string Newsletter_Sent_Delete(string SentIDs)
        {
            ...
            return SepFunctions.LangText("Sent newsletter(s) has been successfully deleted.");
        }
