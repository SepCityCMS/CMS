...
namespace SepCommon.DAL
{
    ...
    public static class GroupLists
    {
        ...
        public static string Group_Users_Delete(long ListID, string UserIDs)
        {
            ...
            return SepFunctions.LangText("Users(s) has been successfully deleted from this group list.");
        }
        ...
        public static string List_Delete(string ListIDs)
        {
            ...
            return SepFunctions.LangText("Group List(s) has been successfully deleted.");
        }
        ...
        public static string List_Save(long ListID, string UserID, string ListName, string Description)
        {
            ...
            string sReturn = SepFunctions.LangText("Group list has been successfully added.");
