...
namespace SepCommon.Core.DAL
{
    ...
    public static class PhotoAlbums
    {
        ...
        public static string Album_Delete(string AlbumIDs)
        {
            ...
            sReturn = SepFunctions.LangText("Album(s) has been successfully deleted.");
        ...
        public static int Album_Save(long AlbumID, string UserID, string AlbumName, string Description, bool SharedAlbum, string AlbumPassword)
        {
            ...
            intReturn = SepFunctions.Additional_Data_Save(isNewRecord, 28, Strings.ToString(AlbumID), UserID, SepFunctions.GetUserInformation("UserName", UserID), "Album", "Photo Album", "CreateAlbum");
