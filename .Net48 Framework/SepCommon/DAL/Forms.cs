...
namespace SepCommon.DAL
{
    ...
    public static class Forms
    {
        ...
        public static string Form_Delete(string FormIDs)
        {
            ...
            return SepFunctions.LangText("Form(s) has been successfully deleted.");
        }
        ...
        public static string Form_Mark_Available(string FormIDs)
        {
            ...
            return SepFunctions.LangText("Form(s) has been marked as available.");
        }
        ...
        public static string Form_Mark_Unavailable(string FormIDs)
        {
            ...
            return SepFunctions.LangText("Form(s) has been marked as unavailable.");
        }
        ...
        public static int Form_Save(long FormID, string Title, string UserID, string Description, string Email, string CompletionURL, long PortalID)
        {
            ...
            int intReturn = SepFunctions.Additional_Data_Save(isNewRecord, 13, Strings.ToString(FormID), UserID, SepFunctions.GetUserInformation("UserName", UserID), "Form", "Form", string.Empty);
            if (intReturn == 0)
            {
                if (bUpdate)
                {
        ...
        public static string Question_Option_Save(long OptionID, long QuestionID, string OptionValue)
        {
            ...
            string sReturn = SepFunctions.LangText("Question option has been successfully added.");
        ...
        public static int Question_Save(long QuestionID, string UserID, long FormID, long SectionID, string QuestionType, string Weight, bool Required, string Question)
        {
            ...
            int intReturn = SepFunctions.Additional_Data_Save(isNewRecord, 13, Strings.ToString(FormID), UserID, SepFunctions.GetUserInformation("UserName", UserID), "FormQuestion", "Form Question", string.Empty);
            if (intReturn == 0)
            {
                if (bUpdate)
                {
        ...
        public static int Section_Save(long SectionID, string UserID, long FormID, long SectionOrder, string SectionName)
        {
            ...
            int intReturn = SepFunctions.Additional_Data_Save(isNewRecord, 13, Strings.ToString(SectionID), UserID, SepFunctions.GetUserInformation("UserName", UserID), "FormSection", "Form Section", string.Empty);
            if (intReturn == 0)
            {
                if (bUpdate)
                {
        ...
        public static string Submissions_Delete(string SubmissionIDs)
        {
            ...
            return SepFunctions.LangText("Submissions(s) has been successfully deleted.");
        }
    }
}