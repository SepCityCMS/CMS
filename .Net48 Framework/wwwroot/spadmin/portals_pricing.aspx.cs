...
// ***********************************************************************
// <copyright file="portals_pricing.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot.spadmin
{
    ...
    /// <summary>
    /// Class portals_pricing.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class portals_pricing : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No pricing plans have been added.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.Portals.Portals_Plan_Delete(sIDs);
        ...
        {
            var dPortals = SepCommon.DAL.Portals.GetPortalPlans(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value);
