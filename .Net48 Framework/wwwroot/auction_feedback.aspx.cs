...
// ***********************************************************************
// <copyright file="auction_feedback.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class auction_feedback : Page
    {
        /// <summary>
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                using (var cmd = new SqlCommand("INSERT INTO AuctionFeedback (FeedbackID, Message, AdID, ToUserID, FromUserID, BORS, Rating, DatePosted, Status) VALUES(@FeedbackID, @Message, @AdID, @ToUserID, @FromUserID, @BORS, @Rating, @DatePosted, '1')", conn))
                {
            ...
            SepFunctions.Redirect(sInstallFolder + "auction_manage.aspx?DoAction=Feedback");
        }
    }
}