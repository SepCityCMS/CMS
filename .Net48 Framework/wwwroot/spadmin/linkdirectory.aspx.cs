...
// ***********************************************************************
// <copyright file="linkdirectory.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class linkdirectory : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Websites");
                    ...
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Link Name");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No links have been added.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    ...
                    {
                        case "DeleteWebsites":
                            var sDeleteResult = SepCommon.DAL.LinkDirectory.Website_Delete(sIDs);
                        ...
                        case "MarkActive":
                            DeleteResult.InnerHtml = SepCommon.DAL.LinkDirectory.Website_Change_Status(sIDs, 1);
                            break;

                        case "MarkPending":
                            DeleteResult.InnerHtml = SepCommon.DAL.LinkDirectory.Website_Change_Status(sIDs, 0);
                            break;
                    }
                }
                catch
        ...
        {
            var dLinksWebsite = SepCommon.DAL.LinkDirectory.GetLinksWebsite(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value);

            dv = new DataView(SepFunctions.ListToDataTable(dLinksWebsite));
            return dv;
        }
