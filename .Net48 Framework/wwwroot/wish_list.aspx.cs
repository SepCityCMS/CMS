...
// ***********************************************************************
// <copyright file="wish_list.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class wish_list : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Items(s)");
                    ...
                    ManageGridView.Columns[3].HeaderText = SepFunctions.LangText("Last Accessed");
                }
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                SepCommon.SepCore.Session.setCookie("returnUrl", SepFunctions.GetInstallFolder() + "wish_list.aspx");
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("You currently do not have any wish list items.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.Favorites.Favorite_Delete(sIDs, SepFunctions.Session_User_ID());
        ...
        {
            var dFavorites = SepCommon.DAL.Favorites.GetFavorites(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value, SepFunctions.Session_User_ID(), true);

            dv = new DataView(SepFunctions.ListToDataTable(dFavorites));
            return dv;
        }
