...
// ***********************************************************************
// <copyright file="classes_keys.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class classes_keys : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Classes");
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Class Name");
                    ManageGridView.Columns[3].HeaderText = SepFunctions.LangText("Private Class");
                }
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No access classes have been added.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.Security.Class_Delete(sIDs);
        ...
        {
            var dAccessClasses = SepCommon.DAL.Security.GetAccessClasses(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value);

            dv = new DataView(SepFunctions.ListToDataTable(dAccessClasses));
            return dv;
        }
