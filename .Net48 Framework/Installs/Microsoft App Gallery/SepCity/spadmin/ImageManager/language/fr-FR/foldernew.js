function getTxt(s) {
    switch (s) {
        case "Folder already exists.":
            return "Le r&eacute;pertoire existe d&eacute;j&agrave;.";
        case "Folder created.":
            return "Le r&eacute;pertoire a &eacute;t&eacute; cr&eacute;&eacute;";
        case "Invalid input.":
            return "La valeur entr\u00E9e ne convient pas."; //"La valeur entr&eacute;e ne convient pas."
    }
}
