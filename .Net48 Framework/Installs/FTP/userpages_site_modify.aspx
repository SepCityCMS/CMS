<%@ page language="C#" viewstatemode="Enabled" masterpagefile="~/skins/template.master"
    codebehind="userpages_site_modify.aspx.cs" inherits="wwwroot.userpages_site_modify" %>
...
<asp:content id="BodyContent" contentplaceholderid="SiteContent" runat="Server">
    ...
    <div class="ModFormDiv" id="ModFormDiv" runat="server">
        ...
        <h4 id="ModifyLegend" runat="server">Create Your Site</h4>
        ...
        <div class="mb-3">
            <label id="TemplateLabel" clientidmode="Static" runat="server" for="TemplateID">Web Site Template:</label>
        ...
        <%
            ...
            cCustomFields.ModuleID = 107;
            cCustomFields.FieldUniqueID = this.SiteID.Value;
