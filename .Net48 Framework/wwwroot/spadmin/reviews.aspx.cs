...
// ***********************************************************************
// <copyright file="reviews.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class reviews : Page
    {
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Reviews");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No reviews have been added.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.Reviews.Review_Delete(sIDs);
        ...
        {
            var dReviews = SepCommon.DAL.Reviews.GetReviews(searchWords: ModuleSearch.Value, ModuleID: SepFunctions.toInt(SepCommon.SepCore.Request.Item("ModuleID")));

            dv = new DataView(SepFunctions.ListToDataTable(dReviews));
            return dv;
        }
    }
}