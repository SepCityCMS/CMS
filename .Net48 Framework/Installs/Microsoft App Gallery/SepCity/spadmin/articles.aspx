<%@ page title="Articles" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="articles.aspx.cs" inherits="wwwroot.articles" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Manage the Articles"></span>
        </h2>
        ...
        <div class="panel panel-default" id="PageManageGridView" runat="server">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                Eval("StatusText").ToString()%>
                    ...
                    <asp:TemplateField HeaderText="Headline Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="Headline_Date">
                        <ItemTemplate>
                            <%#
