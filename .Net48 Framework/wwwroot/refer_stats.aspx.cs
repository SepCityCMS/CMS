...
// ***********************************************************************
// <copyright file="refer_stats.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class refer_stats : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    ManageGridView.Columns[0].HeaderText = SepFunctions.LangText("Email Address");
                    ManageGridView.Columns[1].HeaderText = SepFunctions.LangText("Visitors");
                }
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if ((SepFunctions.Setup(GlobalVars.ModuleID, "ReferEnable") != "Enable" || SepFunctions.Setup(GlobalVars.ModuleID, "ReferDisplayStats") != "Yes") && Response.IsClientConnected)
        ...
        {
            var dReferStats = SepCommon.DAL.Referral.GetReferralStats(ModuleSearch.Value);

            dv = new DataView(SepFunctions.ListToDataTable(dReferStats));
            return dv;
        }
    }
}