<%@ page language="C#" viewstatemode="Enabled" masterpagefile="~/skins/template.master"
    codebehind="auction_manage.aspx.cs" inherits="wwwroot.auction_manage" %>
    ...
    <script type="text/javascript">
        function openFeedback(adId, feedbackId) {
            ...
            $.ajax({
                ...
                url: config.imageBase + "api/auctions/feedback",
                dataType: "json",
...
<asp:content id="BodyContent" contentplaceholderid="SiteContent" runat="Server">
    ...
    <span class="successNotification" id="successNotification2">
    ...
    <div class="panel panel-default" id="PageManageGridView" runat="server">
        ...
        <asp:GridView ID="SellingContent" runat="server" AutoGenerateColumns="False" AllowSorting="False" ClientIDMode="Static"
            ...
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="20px">
                    <ItemTemplate>
                        <a href="auction_modify.aspx?CatID=<%#
                ...
                <asp:TemplateField HeaderText="Current Bid" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top">
                    <ItemTemplate>
                        <%#
        ...
        <asp:GridView ID="SoldContent" runat="server" AutoGenerateColumns="False" AllowSorting="False" ClientIDMode="Static"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Sold Price" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top">
                    <ItemTemplate>
                        <%#
                this.Eval("CurrentBid") %>
                    </ItemTemplate>
        ...
        <asp:GridView ID="BoughtContent" runat="server" AutoGenerateColumns="False" AllowSorting="False" ClientIDMode="Static"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Leave Feedback" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top">
                    <ItemTemplate>
                        <%#
                Convert.ToString(!string.IsNullOrWhiteSpace(Convert.ToString(DataBinder.Eval(Container.DataItem, "BuyerFeedbackID"))) ? "<a href=\"javascript:void(0)\" onclick=\"openFeedback('" + this.Eval("AdID") + "', '" + this.Eval("BuyerFeedbackID") + "');return false;\">View Feedback</a>" : "<a href='auction_feedback.aspx?AdID=" + this.Eval("AdID") + "&SellerUserID=" + this.Eval("UserID") + "'>Leave Feedback</a>") %>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
