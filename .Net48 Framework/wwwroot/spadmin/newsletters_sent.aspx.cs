...
// ***********************************************************************
// <copyright file="newsletters_sent.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class newsletters_sent.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class newsletters_sent : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Sent Newsletters");
                    ManageGridView.Columns[1].HeaderText = SepFunctions.LangText("Email Subject");
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Date Sent");
                }
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No email have been sent to this newsletter.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.Newsletters.Newsletter_Sent_Delete(sIDs);
        ...
        {
            var dNewslettersSent = SepCommon.DAL.Newsletters.GetNewslettersSent(SepFunctions.toLong(SepCommon.SepCore.Request.Item("LetterID")), GridViewSortExpression, GetSortDirection(), ModuleSearch.Value);

            dv = new DataView(SepFunctions.ListToDataTable(dNewslettersSent));
            return dv;
        }
