<%@ page title="Shopping Mall" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="shoppingmall.aspx.cs" inherits="wwwroot.shoppingmall" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Manage the Shopping Mall"></span>
        </h2>
        ...
        <div class="panel panel-default" id="PageManageGridView" runat="server">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                Eval("ProductID").ToString()%>" value="<%#
                Eval("ProductID").ToString()%>" onclick="gridviewSelectRow(this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:templatefield ItemStyle-Width="20px">
                        <itemtemplate>
                            <a href="shoppingmall_modify.aspx?CatID=<%#
                Eval("CatID").ToString()%>&ProductID=<%#
                ...
                Eval("LongPrice").ToString()%>
                    ...
                    <asp:TemplateField HeaderText="Handling Fee" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="Handling">
                        <ItemTemplate>
                                <%#
                    Format_Currency(Eval("Handling").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
