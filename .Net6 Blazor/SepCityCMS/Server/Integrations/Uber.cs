...
namespace SepCityCMS.Server.Integrations
{
    public class Uber
    {
        ...
        public void Login()
        {
            Server.SepFunctions.Redirect("https://login.uber.com/oauth/v2/authorize?response_type=code&client_id=aJQZXH_RvNPD1Gt8tbAJOKdH5jXsZV4A&scope=profile&redirect_uri=https://demo.sepcity.com/uber.aspx");
        }
        ...
        public string GetPricing(string code)
        {
            ...
            {
                Server.SepFunctions.Debug_Log("Access Token: " + accessToken);
                ...
                Server.SepFunctions.Debug_Log("Pricing: " + sReturn);
