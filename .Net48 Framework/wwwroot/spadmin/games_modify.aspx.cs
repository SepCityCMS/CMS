...
// ***********************************************************************
// <copyright file="games_modify.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class games_modify : Page
    {
        /// <summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    ModifyLegend.InnerHtml = SepFunctions.LangText("Edit Game");
                    GameNameLabel.InnerText = SepFunctions.LangText("Game Name:");
                    DescriptionLabel.InnerText = SepFunctions.LangText("Description:");
                    GameNameRequired.ErrorMessage = SepFunctions.LangText("~~Game Name~~ is required.");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (SepFunctions.Admin_Login_Required(SepFunctions.Security("GamesAdmin")))
            {
            ...
            if (SepFunctions.CompareKeys(SepFunctions.Security("GamesAdmin"), true) == false)
            {
            ...
            if (!Page.IsPostBack && !string.IsNullOrWhiteSpace(SepCommon.SepCore.Request.Item("GameID")))
            {
                ...
                {
                    GameID.Value = SepCommon.SepCore.Request.Item("GameID");
                    GameName.Value = jGames.GameName;
                    Description.Value = jGames.Description;
                }
            }
            else
            {
        ...
        {
            var sReturn = SepCommon.DAL.Games.Game_Save(SepFunctions.toLong(GameID.Value), GameName.Value, Description.Value);
