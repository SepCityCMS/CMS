...
namespace SepCityCMS.Server.Controls
{
    ...
    public class ChangeLogDropdown
    {
        ...
        {
            get => SepCore.Strings.ToString(m_ChangeUniqueID);
                    ...
                    using (SqlDataReader RS = cmd.ExecuteReader())
                    {
                        if (RS.HasRows)
                        {
                            ...
                            while (RS.Read())
                            {
                                ...
                                output.AppendLine("<option value=\"" + href + "\"" + SepCore.Strings.ToString(SepFunctions.openNull(RS["ChangeID"]) == Text ? " selected=\"selected\"" : string.Empty) + ">" + SepFunctions.openNull(RS["DateChanged"]) + "</option>");
                            }
