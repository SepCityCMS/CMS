...
namespace SepCityCMS.Server.DAL
{
    ...
    public static class SpeakersBureau
    {
        ...
        public static string Speaker_Delete(string SpeakerIDs)
        {
            ...
            sReturn = SepFunctions.LangText("Speaker(s) has been successfully deleted.");
        ...
        public static int Speaker_Save(long SpeakerID, string UserID, string FirstName, string LastName, string EmailAddress, string Cred, string Bio, string Title, long PortalID)
        {
            ...
            intReturn = SepFunctions.Additional_Data_Save(isNewRecord, 50, Strings.ToString(SpeakerID), UserID, SepFunctions.GetUserInformation("UserName", UserID), "Speaker", "Speaker", string.Empty);
        ...
        public static string Speech_Delete(string SpeechIDs)
        {
            ...
            sReturn = SepFunctions.LangText("Speech has been successfully deleted.");
        ...
        public static int Speech_Save(long SpeechID, string UserID, long SpeakerID, long TopicID, string Subject, long PortalID)
        {
            ...
            intReturn = SepFunctions.Additional_Data_Save(isNewRecord, 50, Strings.ToString(SpeechID), UserID, SepFunctions.GetUserInformation("UserName", UserID), "Speech", "Speaker Bureau Speech", string.Empty);
        ...
        public static int Topic_Save(long TopicID, string UserID, string TopicName, long PortalID)
        {
            ...
            intReturn = SepFunctions.Additional_Data_Save(isNewRecord, 50, Strings.ToString(TopicID), UserID, SepFunctions.GetUserInformation("UserName", UserID), "Topic", "Speaker Bureau Topic", string.Empty);
