...
// ***********************************************************************
// <copyright file="realestate_tenants.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class realestate_tenants.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class realestate_tenants : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public string Format_Birth_Date(string birthDate)
        {
            return Strings.FormatDateTime(SepFunctions.toDate(birthDate), Strings.DateNamedFormat.ShortDate);
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No tenants have been added.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.RealEstate.Tenant_Delete(sIDs);
        ...
        {
            var dRealEstateProperties = SepCommon.DAL.RealEstate.GetRealEstateTenants(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value, SepFunctions.toLong(SepCommon.SepCore.Request.Item("PropertyID")), SepFunctions.Session_User_ID());
