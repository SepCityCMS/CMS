...
// ***********************************************************************
// <copyright file="banners_pricing.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class advertising_pricing.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class advertising_pricing : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Pricing Plans");
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Plan Name");
                    ManageGridView.Columns[3].HeaderText = SepFunctions.LangText("One-time Price");
                    ManageGridView.Columns[4].HeaderText = SepFunctions.LangText("Recurring Price");
                    ManageGridView.Columns[5].HeaderText = SepFunctions.LangText("Recurring Cycle");
                }
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No advertisement pricing have been added.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.Advertisements.Advertisement_Price_Delete(sIDs);
        ...
        {
            var dAdvertisementPrices = SepCommon.DAL.Advertisements.GetAdvertisementPrices(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value);

            dv = new DataView(SepFunctions.ListToDataTable(dAdvertisementPrices));
            return dv;
        }
