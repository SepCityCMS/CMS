...
// ***********************************************************************
// <copyright file="affiliate_history.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class affiliate_history.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class affiliate_history : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    ManageGridView.Columns[0].HeaderText = SepFunctions.LangText("Amount Paid");
                    ManageGridView.Columns[1].HeaderText = SepFunctions.LangText("Date Paid");
                }
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No payment history for this user is available at this time.") + "</div>";
        ...
        {
            var dAffiliateHistory = SepCommon.DAL.Affiliate.GetAffiliateHistory(SepFunctions.toLong(SepCommon.SepCore.Request.Item("AffiliateID")), GridViewSortExpression, GetSortDirection());

            dv = new DataView(SepFunctions.ListToDataTable(dAffiliateHistory));
            return dv;
        }
