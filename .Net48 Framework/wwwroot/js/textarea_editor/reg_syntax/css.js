editAreaLoader.load_syntax["css"] = {
    ...
    'KEYWORDS': {
        ...
        'values': [
            ...
            "landscape", "larger", "large", "left-side", "leftwards", "level", "lighter", "lime", "line-through",
            "list-item", "loud", "lower-alpha", "lower-greek", "lower-roman", "lowercase", "ltr", "lower", "low",
            "maroon", "medium", "message-box", "middle", "mix", "monospace",
            "n-resize", "narrower", "navy", "ne-resize", "no-close-quote", "no-open-quote", "no-repeat", "none",
            "normal", "nowrap", "nw-resize",
            ...
            "s-resize", "sans-serif", "scroll", "se-resize", "semi-condensed", "semi-expanded", "separate", "serif",
            "show", "silent", "silver", "slow", "slower", "small-caps", "small-caption", "smaller", "soft", "solid",
            "spell-out", "square",
            "static", "status-bar", "super", "sw-resize",
            "table-caption", "table-cell", "table-column", "table-column-group", "table-footer-group",
            "table-header-group", "table-row", "table-row-group", "teal", "text", "text-bottom", "text-top", "thick",
            "thin", "transparent",
            "ultra-condensed", "ultra-expanded", "underline", "upper-alpha", "upper-latin", "upper-roman", "uppercase",
            "url",
            "visible",
