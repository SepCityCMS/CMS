...
namespace SepCityCMS.Server.DAL
{
    ...
    public static class HotOrNot
    {
        ...
        public static int Picture_Save(long UploadID, string UserID)
        {
            ...
            intReturn = SepFunctions.Additional_Data_Save(false, 40, SepCore.Strings.ToString(UploadID), UserID, SepFunctions.GetUserInformation("UserName", UserID), "HotOrNot", "Hot or Not", string.Empty);
