...
// ***********************************************************************
// <copyright file="groups.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot.twilio
{
    ...
    public partial class groups : Page
    {
        ...
        private DataView BindData()
        {
            ...
            {
                conn.Open();
                using (var cmd = new SqlCommand("SELECT GroupID, GroupName, '' AS Users FROM TwilioGroups ORDER BY GroupName", conn))
                {
