...
namespace SepCityControls
{
    ...
    public class WYSIWYGEditor
    {
        ...
        public string Mode
        {
            get => SepCommon.SepCore.Strings.ToString(m_Mode);
        ...
        public string Text
        {
            get
            {
                var s = SepCommon.SepCore.Request.Form("txt" + ID);
                if (s == null)
                {
        ...
        public string Render()
        {
            ...
            output.AppendLine("\"autoresize advlist autolink autosave link sepimage" + SepCommon.SepCore.Strings.ToString(Mode == "advanced" ? " sepinsert" : string.Empty) + SepCommon.SepCore.Strings.ToString(Mode == "userpage" ? " sepinsert2" : string.Empty) + " lists charmap\",");
            ...
            if (SepCommon.SepCore.Request.Browser.IsMobileDevice())
            {
            ...
            {
                output.AppendLine("toolbar1: \"cut copy paste | undo redo | searchreplace | fontselect fontsizeselect | indent outdent link charmap" + SepCommon.SepCore.Strings.ToString(Mode == "advanced" ? " sepinsert" : string.Empty) + SepCommon.SepCore.Strings.ToString(Mode == "userpage" ? " sepinsert2" : string.Empty) + "\",");
