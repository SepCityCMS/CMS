...
namespace SepCityControls
{
    ...
    public class ContentRotator
    {
        ...
        public string Render()
        {
            ...
            int iModuleID = SepFunctions.toInt(Session.getSession("ModuleID"));
            var wc = string.Empty;
        ...
        public string Replace_Widgets(string strPageText, int ModuleID)
        {
            ...
            {
                int posa = Strings.InStr(strPageText, "[[Categories||") + Strings.Len("[[Categories||");
                string strNum = Strings.Mid(strPageText, posa, 2);
                var cCat = new CategoryLayout
                {
                    ModuleID = SepFunctions.toInt(strNum)
                };
