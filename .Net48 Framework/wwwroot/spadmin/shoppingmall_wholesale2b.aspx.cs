...
// ***********************************************************************
// <copyright file="shoppingmall_wholesale2b.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class shoppingmall_wholesale2b.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    partial class shoppingmall_wholesale2b : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Feed(s)");
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Feed Name");
                    ManageGridView.Columns[3].HeaderText = SepFunctions.LangText("Feed URL");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No feeds have been added.") + "</div>";
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.ShoppingMall.Wholesale2b_Feed_Delete(sIDs);
        ...
        {
            var dShopWholesale2b = SepCommon.DAL.ShoppingMall.GetShopWholesale2b();

            dv = new DataView(SepFunctions.ListToDataTable(dShopWholesale2b));
            return dv;
        }
    }
}