...
namespace SepCityCMS.Server.DAL
{
    ...
    public static class Articles
    {
        ...
        public static string Article_Change_Status(string ArticleIDs, int Status)
        {
            ...
            return SepFunctions.LangText("Article(s) status has been successfully saved.");
        }
        ...
        public static string Article_Delete(string ArticleIDs)
        {
            ...
            return SepFunctions.LangText("Article(s) has been successfully deleted.");
        }
        ...
        public static string Article_Save(ref long ArticleID, string UserID, long CatID, string Headline, string Author, DateTime Headline_Date, DateTime Start_Date, DateTime End_Date, string Summary, string Full_Article, string Source, string Article_URL, string Meta_Description, string Meta_Keywords, string Related_Articles, int Status, long PortalID)
        {
            var bUpdate = false;
            ...
            if (bUpdate)
            {
                sReturn = SepFunctions.LangText("Article has been successfully updated.");
            }

            sReturn = SepFunctions.LangText("Article has been successfully added.");
