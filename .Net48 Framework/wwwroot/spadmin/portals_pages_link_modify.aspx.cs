...
// ***********************************************************************
// <copyright file="portals_pages_link_modify.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class portals_pages_link_modify.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class portals_pages_link_modify : Page
    {
        /// <summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!Page.IsPostBack && !string.IsNullOrWhiteSpace(SepCommon.SepCore.Request.Item("UniqueID")) && string.IsNullOrWhiteSpace(LinkText.Value))
            {
                ...
                {
                    conn.Open();
                    using (var cmd = new SqlCommand("SELECT * FROM PortalPages WHERE UniqueID=@UniqueID", conn))
                    {
