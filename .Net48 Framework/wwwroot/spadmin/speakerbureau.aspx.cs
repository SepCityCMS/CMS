...
// ***********************************************************************
// <copyright file="speakerbureau.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    public partial class speakerbureau : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Speaker's");
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Last Name");
                    ManageGridView.Columns[3].HeaderText = SepFunctions.LangText("First Name");
                }
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No speakers have been added.") + "</div>";
                PageManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.SpeakersBureau.Speaker_Delete(sIDs);
        ...
        {
            var dSpeakers = SepCommon.DAL.SpeakersBureau.GetSpeakers(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value);

            dv = new DataView(SepFunctions.ListToDataTable(dSpeakers));
            return dv;
        }
