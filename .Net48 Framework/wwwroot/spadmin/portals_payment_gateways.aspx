<%@ page title="Payment Gateways" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="portals_payment_gateways.aspx.cs" inherits="wwwroot.portals_payment_gateways" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Payment Gateways"></span>
        </h2>
