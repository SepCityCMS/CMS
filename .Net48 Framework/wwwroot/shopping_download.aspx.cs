...
// ***********************************************************************
// <copyright file="shopping_download.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class shopping_download.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class shopping_download : Page
    {
        /// <summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            try
            {
                using (var conn = new SqlConnection(SepFunctions.Database_Connection()))
                {
                    ...
                    {
                        cmd.Parameters.AddWithValue("@UploadID", Request.QueryString["FileID"]);
