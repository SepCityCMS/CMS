<%@ page title="Newsletters" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="newsletters_members.aspx.cs" inherits="wwwroot.newsletters_members" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Members in this Newsletter"></span>
        </h2>
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="input-group">
							...
							<button class="btn btn-light" ID="RunAction" runat="server" OnServerClick="RunAction_Click" onclick="if(ExecuteAction(this, 'UserLetterID') == false) {return false} else">Go!</button>
						</span>
					</div>
				</div>
				<div class="col-lg-6">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                <Columns>
                    <asp:TemplateField ItemStyle-Width="20px">
                        ...
                        <ItemTemplate>
                            <input type="checkbox" id="UserLetterID<%#
                Eval("UserLetterID").ToString()%>" value="<%#
                Eval("UserLetterID").ToString()%>" onclick="gridviewSelectRow(this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
