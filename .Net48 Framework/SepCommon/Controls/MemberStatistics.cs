...
namespace SepCityControls
{
    ...
    public class MemberStatistics
    {
        ...
        public string Render()
        {
            ...
            string SqlStr = "SELECT (SELECT Count(UserID) FROM Members WHERE Status=1 AND Month(CreateDate)='" + DateAndTime.Month(DateTime.Today) + "' AND Year(CreateDate)='" + DateAndTime.Year(DateTime.Today) + "' AND Day(CreateDate)='" + DateAndTime.Day(DateTime.Today) + "') AS JoinedToday,";
