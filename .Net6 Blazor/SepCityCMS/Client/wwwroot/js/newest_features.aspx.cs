...
// ***********************************************************************
// <copyright file="newest_features.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class newest_features.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class newest_features : Page
    {
        /// <summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (SepFunctions.Setup(61, "BlogsEnable") == "Enable" && SepFunctions.ModuleActivated(61)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("Newest Blogs"), "[[DisplayNewestBlogs||"));
            ...
            if (SepFunctions.Setup(23, "NewsEnable") == "Enable" && SepFunctions.ModuleActivated(23)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("Newest News"), "[[DisplayNewestNews||"));
            if (SepFunctions.Setup(25, "PollsEnable") == "Enable" && SepFunctions.ModuleActivated(25)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("Newest Polls"), "[[DisplayNewestPolls||"));
            if (SepFunctions.Setup(66, "PCREnable") == "Enable" && SepFunctions.ModuleActivated(66)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("Newest Positions"), "[[DisplayNewestPositions||"));
            if (SepFunctions.Setup(41, "ShopMallEnable") == "Enable" && SepFunctions.ModuleActivated(41)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("Newest Products"), "[[DisplayNewestProducts||"));
            if (SepFunctions.Setup(63, "ProfilesEnable") == "Enable" && SepFunctions.ModuleActivated(63)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("Newest Profiles"), "[[DisplayNewestProfiles||"));
            ...
            if (SepFunctions.Setup(7, "UPagesEnable") == "Enable" && SepFunctions.ModuleActivated(7)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("Newest User Sites"), "[[DisplayNewestUserPages||"));
            ...
            // Sliders
            if (SepFunctions.Setup(35, "ArticlesEnable") == "Enable" && SepFunctions.ModuleActivated(35)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("(Slider) Newest Articles"), "[[DisplayNewestArticles||Slider]]"));
            if (SepFunctions.Setup(41, "ShopMallEnable") == "Enable" && SepFunctions.ModuleActivated(41)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("(Slider) Newest Products"), "[[DisplayNewestProducts||Slider]]"));
            ...
            if (SepFunctions.Setup(23, "NewsEnable") == "Enable" && SepFunctions.ModuleActivated(23)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("(Simple) Newest News"), "[[DisplayNewestNews||Simple]]"));
            if (SepFunctions.Setup(25, "PollsEnable") == "Enable" && SepFunctions.ModuleActivated(25)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("(Simple) Newest Polls"), "[[DisplayNewestPolls||Simple]]"));
            if (SepFunctions.Setup(41, "ShopMallEnable") == "Enable" && SepFunctions.ModuleActivated(41)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("(Simple) Newest Products"), "[[DisplayNewestProducts||Simple]]"));
            if (SepFunctions.Setup(63, "ProfilesEnable") == "Enable" && SepFunctions.ModuleActivated(63)) dinsFeature.Items.Add(new ListItem(SepFunctions.LangText("(Simple) Newest Profiles"), "[[DisplayNewestProfiles||Simple]]"));
