...
namespace SepCommon.DAL.Globals
{
    ...
    public static class Modules
    {
        ...
        public static List<Models.Modules> GetModules(string excludeIDs = "", string includeAdditional = "")
        {
            ...
            {
                var dModules = new Models.Modules { ModuleID = 2 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 35 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 31 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 61 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 20 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 44 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 1 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 5 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 10 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 37 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 46 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 9 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 13 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 12 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 14 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 40 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 19 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 18 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 0 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 23 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 24 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 47 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 28 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 25 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 60 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 32 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 41 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 50 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 7 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 63 };
            ...
            {
                var dModules = new Models.Modules { ModuleID = 36 };
