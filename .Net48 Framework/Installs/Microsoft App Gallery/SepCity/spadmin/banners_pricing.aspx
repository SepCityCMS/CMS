<%@ page title="Advertising" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="advertising_pricing.aspx.cs" inherits="wwwroot.advertising_pricing" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Manage the Advertising Pricing"></span>
        </h2>
        ...
        <div class="panel panel-default" id="PageManageGridView" runat="server">
						...
						<div class="input-group">
							<select id="FilterDoAction" runat="server" class="form-control" ClientIDMode="Static">
								<option value="">Select an Action</option>
									<option value="DeletePlans">Delete Pricing Plans</option>
                    </select>
							<span class="input-group-btn">
							<button class="btn btn-light" ID="RunAction" runat="server" OnServerClick="RunAction_Click" onclick="if(ExecuteAction(this, 'PriceID') == false) {return false} else">Go!</button>
						</span>
					</div>
				</div>
				<div class="col-lg-6">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                Eval("PriceID").ToString()%>" value="<%#
                Eval("PriceID").ToString()%>" onclick="gridviewSelectRow(this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:templatefield ItemStyle-Width="20px">
                        <itemtemplate>
                            <a href="banners_pricing_modify.aspx?PriceID=<%#
                Eval("PriceID").ToString()%>">
                                <img src="../images/public/edit.png" alt="Edit" />
                            </a>
                        </itemtemplate>
                    </asp:templatefield>
                    <asp:TemplateField HeaderText="Plan Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="PlanName">
                        <ItemTemplate>
                            <%#
                Eval("PlanName").ToString()%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="One-time Price" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="OnetimePrice">
                        <ItemTemplate>
                            <%#
                Eval("OnetimePrice").ToString()%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Recurring Price" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="RecurringPrice">
                        <ItemTemplate>
                            <%#
                Eval("RecurringPrice").ToString()%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Recurring Cycle" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="RecurringCycle">
                        <ItemTemplate>
                            <%#
                Eval("RecurringCycle").ToString()%>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
