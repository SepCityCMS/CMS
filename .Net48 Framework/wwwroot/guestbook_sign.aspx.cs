...
// ***********************************************************************
// <copyright file="guestbook_sign.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class guestbook_sign.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class guestbook_sign : Page
    {
        /// <summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (SepFunctions.Setup(GlobalVars.ModuleID, "GuestbookEnable") != "Enable" && Response.IsClientConnected)
                SepFunctions.Redirect(sInstallFolder + "error.aspx?ErrorID=404");

            if (string.IsNullOrWhiteSpace(SepFunctions.Session_User_Name()) && Response.IsClientConnected)
            {
                SepCommon.SepCore.Session.setCookie("returnUrl", SepFunctions.GetInstallFolder() + "guestbook_sign.aspx");
            ...
            if (!IsPostBack) EntryID.Value = Strings.ToString(SepFunctions.GetIdentity());
        }
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            ErrorMessage.InnerHtml = Globals.GetSaveMessage(Master, GlobalVars.ModuleID, intReturn, EmailAddress.Value);
