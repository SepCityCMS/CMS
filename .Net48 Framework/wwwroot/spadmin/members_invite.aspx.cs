...
// ***********************************************************************
// <copyright file="members_invite.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class members_invite.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class members_invite : Page
    {
        /// <summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    ModifyLegend.InnerHtml = SepFunctions.LangText("Invite Member");
                    ...
                    JoinClassLabel.InnerText = SepFunctions.LangText("Access Class this member will join when they signup:");
        ...
        {
            var sReturn = SepCommon.DAL.Members.Member_Invite(EmailAddress.Value, FirstName.Value, LastName.Value, JoinClass.Text);
