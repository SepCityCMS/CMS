        ...
        public string Render()
        {
            ...
            switch (ModuleID)
            {
                ...
                case 988:
                    ...
                    output.AppendLine("<li class=\"nav-item dropdown\"><a class=\"nav-link dropdown-toggle\" id=\"Menu" + ModuleID + "\" aria-haspopup=\"true\" aria-expanded=\"false\" data-toggle=\"dropdown\" href=\"#\">" + SepFunctions.LangText("API Calls") + "</a>");
                    output.AppendLine("<div class=\"dropdown-menu\" aria-labelledby=\"Menu" + ModuleID + "\">");
                    output.AppendLine("<a class=\"dropdown-item\" href=\"api_calls.aspx?PortalID=" + SepFunctions.Get_Portal_ID() + "\">" + SepFunctions.LangText("Manage") + "</a>");
                    output.AppendLine("<a class=\"dropdown-item\" href=\"api_calls_modify.aspx?PortalID=" + SepFunctions.Get_Portal_ID() + "\">" + SepFunctions.LangText("Add API Call") + "</a>");
                    output.AppendLine("</div>");
                    output.AppendLine("</li>");
                    break;
