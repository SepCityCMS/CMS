...
// ***********************************************************************
// <copyright file="messenger_find_user.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class messenger_find_user.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class messenger_find_user : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            SepFunctions.RequireLogin(SepFunctions.Security("MessengerFind"));

            if (string.IsNullOrWhiteSpace(SepFunctions.Session_User_Name()) && Response.IsClientConnected)
            {
                SepCommon.SepCore.Session.setCookie("returnUrl", SepFunctions.GetInstallFolder() + "messenger_find_user.aspx");
                SepFunctions.Redirect(sInstallFolder + "login.aspx");
            }

            var arrHeader = Strings.Split(SepFunctions.PageHeader(GlobalVars.ModuleID), "|$$|");
            Array.Resize(ref arrHeader, 3);
            Page.Title = arrHeader[0] + " - " + SepFunctions.LangText("Find a User");
        ...
        /// <summary>
        /// Handles the Click event of the SubmitFind control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs" /> instance containing the event data.</param>
        ...
        {
            var dFindUser = SepCommon.DAL.Members.GetMembers(searchWords: Keywords.Value);

            dv = new DataView(SepFunctions.ListToDataTable(dFindUser));
            return dv;
        }
    }
}