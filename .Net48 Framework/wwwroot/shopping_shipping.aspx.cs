...
// ***********************************************************************
// <copyright file="shopping_shipping.aspx.cs" company="SepCity, Inc.">
...
namespace wwwroot
{
    ...
    /// <summary>
    /// Class shopping_shipping.
    /// Implements the <see cref="System.Web.UI.Page" />
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class shopping_shipping : Page
    {
        /// <summary>
        /// The c common
        /// </summary>
        ...
        public void TranslatePage()
        {
            if (!Page.IsPostBack)
            {
                ...
                if (SepFunctions.DebugMode || (sSiteLang != "EN-US" && !string.IsNullOrWhiteSpace(sSiteLang)))
                {
                    ...
                    FilterDoAction.Items[1].Text = SepFunctions.LangText("Delete Shipping Methods");
                    ManageGridView.Columns[2].HeaderText = SepFunctions.LangText("Method Name");
                }
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (StoreID == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-danger\" role=\"alert\">" + SepFunctions.LangText("Access Denied. You do not have a store setup.") + "</div>";
                return;
            }
            ...
            if (ManageGridView.Rows.Count == 0)
            {
                DeleteResult.InnerHtml = "<div class=\"alert alert-info\" role=\"alert\">" + SepFunctions.LangText("No shipping methods have been added.") + "</div>";
                ManageGridView.Visible = false;
            }
        }
        ...
        protected void RunAction_Click(object sender, EventArgs e)
        {
            ...
            if (Strings.Len(sIDs) > 0)
            {
                try
                {
                    var sDeleteResult = SepCommon.DAL.ShoppingMall.Shipping_Delete(sIDs);
        ...
        {
            var dShopShipping = SepCommon.DAL.ShoppingMall.GetShopShippingMethods(GridViewSortExpression, GetSortDirection(), ModuleSearch.Value, SepCommon.DAL.ShoppingMall.Store_Get_StoreID(SepFunctions.Session_User_ID()));

            dv = new DataView(SepFunctions.ListToDataTable(dShopShipping));
            return dv;
        }
