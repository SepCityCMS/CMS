<%@ page title="E-Learning" language="C#" viewstatemode="Enabled" masterpagefile="Site.Master"
    codebehind="elearning_students.aspx.cs" inherits="wwwroot.elearning_students" %>
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Panel ID="UpdatePanel" runat="server">
        ...
        <h2>
            <span ID="PageHeader" runat="server" Text="Manage the E-Learning Student"></span>
        </h2>
        ...
        <div class="panel panel-default" id="PageManageGridView" runat="server">
						...
						<div class="input-group">
							<select id="FilterDoAction" runat="server" class="form-control" ClientIDMode="Static">
								<option value="">Select an Action</option>
									<option value="DeleteStudents">Delete Students</option>
                    </select>
							<span class="input-group-btn">
							<button class="btn btn-light" ID="RunAction" runat="server" OnServerClick="RunAction_Click" onclick="if(ExecuteAction(this, 'StudentID') == false) {return false} else">Go!</button>
						</span>
					</div>
				</div>
				<div class="col-lg-6">
            ...
            <asp:GridView ID="ManageGridView" runat="server" AutoGenerateColumns="False" AllowSorting="True" ClientIDMode="Static"
                ...
                Eval("StudentID").ToString()%>" value="<%#
                Eval("StudentID").ToString()%>" onclick="gridviewSelectRow(this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:templatefield ItemStyle-Width="20px">
                        <itemtemplate>
                            <a href="elearning_students_modify.aspx?StudentID=<%#
                ...
                Eval("LastName").ToString()%>
                    ...
                    <asp:TemplateField HeaderText="Date Enrolled" HeaderStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" SortExpression="DateEnrolled">
                        <ItemTemplate>
                            <%#
                Format_Date(Eval("DateEnrolled").ToString())%>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
